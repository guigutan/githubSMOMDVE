...
namespace SIE.XPCJ.BussInspects
{
    ...
    public partial class DefectSelectCtr : UserControl
    {
        public bool ShowQtyInput = false;
        public DefectSelectCtr()
        {
            InitializeComponent();
        }
        ...
        /// 当前工序的所有缺陷数据
        /// </summary>
        private List<Defect> DefectListData { get; set; } = new List<Defect>();

        /// <summary>
        /// 所有缺陷项目
        /// </summary>
        private List<DefectItem> DefectList { get; set; } = new List<DefectItem>();

        /// <summary>
        /// 当前列表中的缺陷项目
        /// </summary>
        private List<DefectItem> CurrentDefectList { get; set; } = new List<DefectItem>();

        /// <summary>
        /// 所有分类
        /// </summary>
        private List<DefectCategoryItem> CategoryList { get; set; } = new List<DefectCategoryItem>();

        /// <summary>
        /// 选中的分类
        /// </summary>
        private List<DefectCategoryItem> SelectedCategoryList { get; set; } = new List<DefectCategoryItem>();

        /// <summary>
        /// 当前列表中的分类
        /// </summary>
        private List<DefectCategoryItem> CurrentCategoryList { get; set; } = new List<DefectCategoryItem>();
        ...
        /// 初始化数据
        /// </summary>
        public void InittalizeData(List<Defect> defectListData)
        {
            this.DefectListData = defectListData;
        ...
        /// </summary>
        /// <returns></returns>
        public List<DefectItem> GetDefectResult()
        {
        ...
        /// 清除所有缺陷
        /// </summary>
        public void ClearAllDefect()
        {
            this.CurrentDefectList.Clear();
            this.allCategoryItem.Clear();
            this.CategoryList.Clear();
            this.currentDefectCategoryButtons.Clear();
            this.defectCategoryButtons.Clear();
            this.allDefectButtonList.Clear();
            flowLayoutPanel3.Controls.Clear();
            flowLayoutPanel1.Controls.Clear();
            flowLayoutPanel2.Controls.Clear();
            flowLayoutPanel4.Controls.Clear();
            flowLayoutPanel1.Controls.Add(xpButton1);
        }
    }
}
