...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发检具与产品的关系数据
    /// </summary>
    [Job("总控向子工厂下发检具与产品的关系数据", typeof(JobParameter))]
    public class SendGroupCheckerItemToFactoryJob : JobBase
    {
        /// <summary>
        /// Job执行方法
        /// </summary>
        ...
        {
            var redisKey = "SendGroupCheckerItemToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.CheckerItem);
