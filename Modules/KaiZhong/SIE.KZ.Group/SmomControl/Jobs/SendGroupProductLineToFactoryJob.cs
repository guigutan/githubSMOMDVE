...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发产品与产线的关系数据
    /// </summary>
    [Job("总控向子工厂下发产品与产线的关系数据", typeof(JobParameter))]
    public class SendGroupProductLineToFactoryJob : JobBase
    {
        /// <summary>
        /// Job执行方法
        /// </summary>
        ...
        {
            var redisKey = "SendGroupProductLineToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.ProductLine);
