...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发可疑品阈值数据
    /// </summary>
    [Job("总控向子工厂下发可疑品阈值数据", typeof(JobParameter))]
    public class SendGroupThresholdToFactoryJob: JobBase
    {
        /// <summary>
        /// Job执行方法
        /// </summary>
        ...
        {
            var redisKey = "SendGroupThresholdToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.Threshold);
