...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发工装维护数据
    /// </summary>
    [Job("总控向子工厂下发工装维护数据", typeof(JobParameter))]
    public class SendGroupFixtureUpholdToFactoryJob : JobBase
    {
        /// <summary>
        /// Job执行方法
        /// </summary>
        ...
        {
            var redisKey = "SendGroupFixtureUpholdToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.FixtureUphold);
