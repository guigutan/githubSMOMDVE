...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发产线与安灯区域数据
    /// </summary>
    [Job("总控向子工厂下发产线与安灯区域数据", typeof(JobParameter))]
    public class SendGroupAndonLineToFactoryJob : JobBase
    {
        /// <summary>
        /// Job执行方法
        /// </summary>
        ...
        {
            var redisKey = "SendGroupAndonLineToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.AndonLine);
