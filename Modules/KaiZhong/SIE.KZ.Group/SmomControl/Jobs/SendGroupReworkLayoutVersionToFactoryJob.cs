...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发返工工艺路线版本数据
    /// </summary>
    [Job("总控向子工厂下发返工工艺路线版本数据", typeof(JobParameter))]
    public class SendGroupReworkLayoutVersionToFactoryJob : JobBase
    {
        /// <summary>
        /// Job执行方法
        /// </summary>
        ...
        {
            var redisKey = "SendGroupReworkLayoutVersionToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.ReworkLayoutVersion);
