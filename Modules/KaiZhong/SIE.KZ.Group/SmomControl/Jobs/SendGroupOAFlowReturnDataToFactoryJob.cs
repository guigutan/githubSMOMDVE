...
namespace SIE.KZ.Group.SmomControl.Jobs
{
    ...
    /// 总控向子工厂下发OA流程退回数据
    /// </summary>
    [Job("总控向子工厂下发OA流程退回数据", typeof(JobParameter))]
    public class SendGroupOAFlowReturnDataToFactoryJob : JobBase
    {
        protected override void ExecuteJob(object param)
        {
            var redisKey = "SendGroupOAFlowReturnDataToFactoryJob" + RT.InvOrg;
            string lockId = null;
            ...
            try
            {
                ...
                var curMsg = RT.Service.Resolve<GroupFactoryJobController>().CorpFactoryJobExecute(InfType.OAFlowReturn);
