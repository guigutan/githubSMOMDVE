SIE.defineCommand('SIE.Web.Andon.Andons.Commands.AndonTypeTriggerPowerAddWorkGroupCommand', {
    extend: 'SIE.cmd.Add',
    meta: { text: "添加班组", group: "edit", iconCls: "icon-AddEntity icon-green" },
            ...
            SIE.AutoUI.getMeta({
                ...
                callback: function (res) {
                    ...
                    SIE.invokeDataQuery({
                        ...
                        method: "GetWorkGroupAlternative",
                        ...
                        listeners: {
                            specialKey: function (field, e) {
                                if (e.getKey() == Ext.EventObject.ENTER) {
                                    ...
                                    var searchTxt = this.ownerCt.child("[name = workgroup_searchTxt]");
                                    var Filter = {
                                        Method: "GetWorkGroupAll",
                            ...
                            items: [{
                                ...
                                handler: function () {
                                    ...
                                    for (var i = 0; i < selectList.length; i++) {
                                        ...
                                        if (index >= 0) {
                                            var msg = '班组['.L10N() + selectList[i].data.Code + ']已添加,不允许重复添加!'.L10N();
                                            SIE.Msg.showMessage(msg);
                                            return
                                        }
                                    }
