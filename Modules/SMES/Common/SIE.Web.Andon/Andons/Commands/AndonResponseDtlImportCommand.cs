...
{
    public class AndonResponseDtlImportCommand: ImportExcelCommand
    {
        /// <summary>
        /// 父Id
        /// </summary>
        ...
        protected override void OnSave(IList<RowData> batch)
        {
            batch.ForEach(p =>
            {
                var entity = p.Entity as AndonResponseDetail;
                entity.AndonId = parentId;//andons.FirstOrDefault(x => x.AndonCode == entity.Andon.AndonCode);
            });
            base.OnSave(batch);
        }
    }
