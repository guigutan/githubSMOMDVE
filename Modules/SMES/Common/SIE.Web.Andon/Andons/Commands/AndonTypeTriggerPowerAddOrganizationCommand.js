SIE.defineCommand('SIE.Web.Andon.Andons.Commands.AndonTypeTriggerPowerAddOrganizationCommand', {
    extend: 'SIE.cmd.Add',
    meta: { text: "添加部门", group: "edit", iconCls: "icon-AddEntity icon-green" },
    showView: function (editEntity) {
        ...
        if (!this.viewMeta) {
            SIE.AutoUI.getMeta({
                model: "SIE.Common.Organizations.Organization",
                ignoreCommands: true,
                isDetail: false,
                ignoreQuery: true,
                viewGroup: "SelectOrganizationView",
                callback: function (res) {
                    ...
                    SIE.invokeDataQuery({
                        ...
                        method: "GetOrganizationAlternative",
                        ...
                        listeners: {
                            specialKey: function (field, e) {
                                if (e.getKey() == Ext.EventObject.ENTER) {
                                    ...
                                    var searchTxt = this.ownerCt.child("[name = organization_searchTxt]");
                                    var Filter = {
                                        Method: "GetOrganizationAll",
                            ...
                            items: [{
                                ...
                                handler: function () {
                                    ...
                                    for (var i = 0; i < selectList.length; i++) {
                                        ...
                                        if (index >= 0) {
                                            var msg = '部门['.L10N() + selectList[i].data.Code + ']已添加,不允许重复添加!'.L10N();
                                            SIE.Msg.showMessage(msg);
                                            return
                                        }
                                    }
