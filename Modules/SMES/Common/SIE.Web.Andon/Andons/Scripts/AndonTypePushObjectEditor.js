Ext.define('SIE.Web.Andon.Andons.Scripts.AndonTypePushObjectEditor', {
    ...
    onClick: function (field, trigger, e) {
        ...
        var type = row_data.getType();
        if (!this.viewMeta) {
            SIE.AutoUI.getMeta({
                model: "SIE.Andon.Andons.ViewModels.AndonTypePushObjectViewModel",
                ignoreCommands: true,
                isDetail: false,
                ignoreQuery: true,
                viewGroup: "PushObjectViewGroup",
                    ...
                    var win = SIE.Window.show({
                        ...
                        callback: function (btn) {
                            if (btn == '确定'.t()) {
                                ...
                                pushObject.setCode(items.getCode());
                                pushObject.setName(items.getName());
                            }
                        }
                    });
                }
