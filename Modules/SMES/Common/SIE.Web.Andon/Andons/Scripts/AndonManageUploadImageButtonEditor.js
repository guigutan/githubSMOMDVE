Ext.define('SIE.Web.Andon.Andons.Scripts.AndonManageUploadImageButtonEditor', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget.andonmanageimagebtn',
    layout: 'vbox',
    _imageDom: null,
    items: [
        {
            ...
            listeners: {
                change: function (field, newValue, oldValue) {
                    if (!field.fileInputEl.dom) {
                        Ext.MessageBox.alert("提示".t(), "请选择正确的文件格式文件上传(.jpg、.png等)！请勿重复连续点击上传文件！请退出重新修改！".t());
                        return;
                    }
