Ext.define('SIE.Web.Andon.Andons.Scripts.AndonManageUploadImageEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.andonuploadimage',
    ...
    _createLayout: function (field) {
        ...
        var entity = Ext.create("SIE.Andon.Andons.ViewModels.AndonManageImageViewModel");
        var detailView = null;
        SIE.AutoUI.getMeta({
            async: false,
            ...
            model: "SIE.Andon.Andons.ViewModels.AndonManageImageViewModel",
                        ...
                        if (btn == "确定".t()) {
                            ...
                            SIE.invokeDataQuery({
                                ...
                                callback: function (result) {
                                    if (result.Success) {
                                        if (result.Result != "") {
                                            detailView.mainView.getCurrent().setPhotoFile(result.Result);
                                            return false;
                                        }
                                    }
                                },
