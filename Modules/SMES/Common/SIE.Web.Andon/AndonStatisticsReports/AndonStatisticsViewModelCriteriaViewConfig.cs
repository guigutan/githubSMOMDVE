...
namespace SIE.Web.Andon.AndonStatisticsReports
{
    ...
    ///安灯统计查询视图配置
    /// </summary>
    public class AndonMonthViewModelCriteriaViewConfig : WebViewConfig<AndonStatisticsViewModelCriteria>
    {
        /// <summary>
        /// 配置查询视图
        /// </summary>
        protected override void ConfigQueryView()
        {
            ...
            View.ReplaceCommands(WebCommandNames.ExecuteQuery, "SIE.Web.Andon.AndonStatisticsReports.Commands.AndonReportQuery");
            using (View.OrderProperties())
            {
                ...
                View.Property(p => p.CreateTime).UseDateRangeEditor(p => p.DateRangeType = ObjectModel.DateRangeType.LastMonth).Show();
