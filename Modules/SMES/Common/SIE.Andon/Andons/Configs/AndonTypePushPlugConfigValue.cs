...
namespace SIE.Andon.Andons.Configs
{
    ...
    [Label("推送模块默认值")]
    public class AndonTypePushPlugConfigValue : ConfigValue
    {
        #region 推送模块默认值 PushPugDefault
        /// <summary>
        /// 推送模块默认值Id
        /// </summary>
        [Label("推送模块默认值")]
        public static readonly IRefIdProperty PushPugDefaultIdProperty =
            P<AndonTypePushPlugConfigValue>.RegisterRefId(e => e.PushPugDefaultId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<PushPlug> PushPugDefaultProperty =
            P<AndonTypePushPlugConfigValue>.RegisterRef(e => e.PushPugDefault, PushPugDefaultIdProperty);
