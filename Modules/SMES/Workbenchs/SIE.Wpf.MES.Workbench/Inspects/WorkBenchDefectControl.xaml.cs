...
namespace SIE.Wpf.MES.Workbench.Inspects
{
    ...
    public partial class WorkBenchDefectControl : UserControl
    {
        ...
        public static readonly DependencyProperty SelectedValueProperty =
            DependencyProperty.Register("SelectedValue", typeof(ObservableCollection<DefectItem>), typeof(WorkBenchDefectControl), new PropertyMetadata(new ObservableCollection<DefectItem>(), (s, e) => { ((WorkBenchDefectControl)s).OnValueChanged(e); }));
        ...
        /// 缺陷分类项目 字典
        /// </summary>
      readonly  Dictionary<double, DefectCategoryItemInfo> allCategoryItem = new Dictionary<double, DefectCategoryItemInfo>();
        ...
        IEnumerable<DefectItem> FindItems(DefectCategoryItemInfo selected)
        {
