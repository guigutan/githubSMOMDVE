...
{
    public class AssemblyProcessEditor : LockableLookUpEditor
    {
        /// <summary>
        /// 资源编辑器名称
        /// </summary>
        public new const string EditorName = "AssemblyProcessEditor";
        ...
        protected override EntityList GetDataSourceCore(Entity source, PagingInfo pagingInfo, string keyword, IManagedProperty titleProperty)
        {
            ...
            return RT.Service.Resolve<ProcessController>().GetProcesssByUserId(workstation.EmployeeId.Value, keyword, new List<ProcessType>() { ProcessType.Assembly });
        }
    }
}