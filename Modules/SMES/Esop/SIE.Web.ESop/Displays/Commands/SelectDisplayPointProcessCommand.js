/**
  ...
  * 
*/
SIE.defineCommand('SIE.Web.ESop.Displays.Commands.SelectDisplayPointProcessCommand', {
        ...
        if (selections && selections.length > 0) {
            ...
            SIE.each(selections, function (item) {
                ...
                if (me._sourceViewSelectItems.indexOf(processId) === -1) {
                    var processDisplayPoint = { DisplayPointId: me._sourceId, ProcessId: processId };
                    operationDatas.push(processDisplayPoint);
                }
            });
