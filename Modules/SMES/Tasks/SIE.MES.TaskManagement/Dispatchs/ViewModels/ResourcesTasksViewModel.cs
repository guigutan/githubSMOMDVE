...
namespace SIE.MES.TaskManagement.Dispatchs.ViewModels
{
    ...
    public class ResourcesTasksViewModel : ViewModel
    {
        ...
        /// </summary>
        [Label("任务单状态")]
        public static readonly Property<DispatchTaskStatus> TaskStatusProperty = P<ResourcesTasksViewModel>.Register(e => e.TaskStatus);
        ...
        /// </summary>
        [Label("计划开始时间")]
        public static readonly Property<DateTime> PlanBeginTimeProperty = P<ResourcesTasksViewModel>.Register(e => e.PlanBeginTime);
        ...
        /// </summary>
        [Label("计划完成时间")]
        public static readonly Property<DateTime> PlanEndTimeProperty = P<ResourcesTasksViewModel>.Register(e => e.PlanEndTime);
