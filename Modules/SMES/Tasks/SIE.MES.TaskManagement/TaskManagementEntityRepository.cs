...
[assembly: Repository(typeof(TaskManagementEntityRepository<>))]
namespace SIE.MES.TaskManagement
{
    ...
    public class TaskManagementEntityRepository<T> : EntityRepository<T>
            where T : Entity
    {
    ...
    /// 任务管理数据提供者
    /// </summary>
    public class TaskManagementEntityDataProvider : RdbDataProvider
    {
        /// <summary>
        /// 数据库连接字符串的名称
        /// </summary>
