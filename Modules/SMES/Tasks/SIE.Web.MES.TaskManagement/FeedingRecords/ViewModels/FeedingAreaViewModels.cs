...
namespace SIE.Web.MES.TaskManagement.FeedingRecords.ViewModels
{
    /// <summary>
    /// 供料区条码化打印 ViewModel
    /// </summary> 
    ...
    [Label("供料区条码化打印")]
    public class FeedingAreaViewModels : ViewModel
    {
        ...
        public static readonly IRefIdProperty TemplateIdProperty =
            P<FeedingAreaViewModels>.RegisterRefId(e => e.TemplateId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<PrintTemplate> TemplateProperty =
            P<FeedingAreaViewModels>.RegisterRef(e => e.Template, TemplateIdProperty);
        ...
        /// 打印 视图
        /// </summary>
        internal class FeedingAreaViewModelConfig : WebViewConfig<FeedingAreaViewModels>
        {
            /// <summary>
            /// 配置明细视图
            /// </summary>
            protected override void ConfigDetailsView()
            {
                ...
                {
                    var model = source as FeedingAreaViewModels;
                    Check.NotNull(model, nameof(FeedingAreaViewModels));
                    var qualifiedName = typeof(FeedingAreaPrintable).GetQualifiedName();
