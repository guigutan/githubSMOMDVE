SIE.defineCommand('SIE.Web.MES.TaskManagement.FeedingRecords.Commands.DeductionRecordEditCommand', {
    ...
    execute: function (view, source) {
        ...
        if (list == null || list.length < 1)
            SIE.Msg.showError("没有找到扣料记录".t());

        SIE.AutoUI.getMeta({
            model: 'SIE.MES.TaskManagement.FeedingRecords.DeductionRecord',
            viewGroup:'EditView',
            ignoreCommands: true,
            isDetail: false,
            ignoreQuery: true,
