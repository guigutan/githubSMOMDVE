SIE.defineCommand('SIE.Web.MES.TaskManagement.FeedingRecords.Commands.FeedingAreaLabelPrintCommand', {
    meta: { text: "供料区条码化打印", group: "edit", iconCls: "icon-PrintData icon-blue" },
    ...
    execute: function (view, source) {
        ...
        SIE.AutoUI.getMeta({
            model: "SIE.Web.MES.TaskManagement.FeedingRecords.ViewModels.FeedingAreaViewModels",
                                    ...
                                    if (rstPrint.ErrMsg !== '') {
                                        ...
                                        if (cfg && cfg.printCallback) {
                                            ...
                                            if (!printCmpt.hasError()) {
                                                ...
                                                if (!printCmpt.hasError())
                                                    CRT.Workbench.showPageDialog({ id: 'Print_rpt', text: "供料区条码化打印".t(), method: 'POST', url: printUrl, params: param });
                                            }
                                        }
