SIE.defineCommand('SIE.Web.MES.TaskManagement.Specifications.Commands.SpecificationCategoryCopyCommand', {
    extend: 'SIE.cmd.Copy',
    ...
    getEditEntity: function () {
        var specificationCategory = this.view.getCurrent();
        var copyEntity = this.view.copyEntity(specificationCategory);
