...
namespace SIE.Web.MES.TaskManagement.ProcessPrepareRecords
{
    public class ProcessPrepareRecordDetailViewConfig : WebViewConfig<ProcessPrepareRecordDetail>
    {
        ...
        {
            View.DisableEditing();
            View.UseCommands(typeof(ProcessPrepareRecordExportCommand).FullName);
        ...
        protected void ExecuteView()
        {
            using (View.OrderProperties())
            {
                View.UseCommands("SIE.Web.MES.TaskManagement.ProcessPrepareRecords.Commands.RecordDetailAllPassCommand");
