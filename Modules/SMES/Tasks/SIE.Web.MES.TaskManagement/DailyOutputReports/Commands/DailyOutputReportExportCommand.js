SIE.defineCommand('SIE.Web.MES.TaskManagement.DailyOutputReports.Commands.DailyOutputReportExportCommand', {
    meta: { text: "导出Excel", hierarchy: "导出".t(), group: "business", iconCls: "icon-ExportData icon-blue" },
    myview: null, // 当前视图对象
    fieldNames: [],//导出的数据
    ...
    execute: function (view, source) {
        ...
        var me = this;
        me.myview = view;
        var grid = me.onBeforeDocumentSave(me.myview);
    ...
    onBeforeDocumentSave: function (myview) {
        var me = this;
