...
namespace SIE.Wpf.MES.TaskManagement.KZReports
{
    ...
    /// 任务单报工 UI模板
    /// </summary>
    public class KZTaskReportExtrusionUITemplate : KZCollectionUITemplate
    {
        /// <summary>
        /// 报工主界面
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public KZTaskReportExtrusionUITemplate() : base(typeof(KZTaskReportExtrusionViewModel))
        {
        }
        ...
        {
            var model = new KZTaskReportExtrusionViewModel();
