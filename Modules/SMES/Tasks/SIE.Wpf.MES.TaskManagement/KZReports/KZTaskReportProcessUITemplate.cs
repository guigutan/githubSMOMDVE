...
namespace SIE.Wpf.MES.TaskManagement.KZReports
{
    ...
    /// 任务单报工 UI模板
    /// </summary>
    public class KZTaskReportProcessUITemplate : KZCollectionUITemplate
    {
        /// <summary>
        /// 报工主界面
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public KZTaskReportProcessUITemplate() : base(typeof(KZTaskReportProcessViewModel))
        {
        }
        ...
        {
            var model = new KZTaskReportProcessViewModel();
