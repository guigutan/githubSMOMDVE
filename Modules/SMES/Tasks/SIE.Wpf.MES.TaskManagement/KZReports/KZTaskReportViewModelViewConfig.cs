...
namespace SIE.Wpf.MES.TaskManagement.KZReports
{
    ...
    /// 任务单报工 视图配置
    /// </summary>
    internal class KZTaskReportViewModelViewConfig : WPFViewConfig<KZTaskReportViewModel>
    {
        /// <summary>
        /// 任务单报检视图
        /// </summary>
        ...
        protected override void ConfigView()
        {
            ...
            View.ClearCommands();
            View.AssignAuthorize(typeof(KZTaskReportViewModel));
            ...
            //        {
            //            var record = e as KZTaskReportViewModel;
            //            if (record == null)
        ...
        private void TaskReportPrintView()
        {
            ...
            using (View.OrderProperties())
            {
                ...
                {
                    var labelPrintName = typeof(SIE.MES.TaskManagement.Reports.ReportRecordPrintable).GetQualifiedName();
