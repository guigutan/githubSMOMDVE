...
namespace SIE.Wpf.MES.TaskManagement.KZReports
{
    ...
    /// 任务单报工 UI模板
    /// </summary>
    public class KZTaskReportUITemplate : KZCollectionUITemplate
    {
        /// <summary>
        /// 报工主界面
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public KZTaskReportUITemplate() : base(typeof(KZTaskReportViewModel))
        {
        }
        ...
        {
            var model = new KZTaskReportViewModel();
