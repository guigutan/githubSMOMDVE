...
namespace SIE.Web.MES.TeamManagement.SikllAuthentications.Commands
{
    ...
    /// 实操记录导入
    /// </summary>
    [JsCommand("SIE.Web.MES.TeamManagement.SikllAuthentications.Commands.OperationRecordImportCommand")]
    public class OperationRecordImportCommand : ImportCommandBase
    {
        /// <summary>
        /// 导入完成
        /// </summary>
        ...
        {
            return typeof(ImportOperationRecordWebHandle);
        }
        ...
        {
            return new List<string> { "1001", "张三", "男", "在职", "李四", "熟练，通过", "2019年6月1日 20:00:00", "通过" };
        }
    }
}