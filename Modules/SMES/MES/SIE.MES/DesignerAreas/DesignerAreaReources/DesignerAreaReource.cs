...
namespace SIE.MES.DesignerAreas
{
    ...
    [Label("看板区域产线")]
    public class DesignerAreaReource : DataEntity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public DesignerAreaReource()
        {
        }
        ...
        public static readonly IRefIdProperty DesignerAreaIdProperty =
            P<DesignerAreaReource>.RegisterRefId(e => e.DesignerAreaId, ReferenceType.Parent);
        ...
        public static readonly RefEntityProperty<DesignerArea> DesignerAreaProperty =
            P<DesignerAreaReource>.RegisterRef(e => e.DesignerArea, DesignerAreaIdProperty);
        ...
        public static readonly IRefIdProperty ResourceIdProperty =
            P<DesignerAreaReource>.RegisterRefId(e => e.ResourceId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<WipResource> ResourceProperty =
            P<DesignerAreaReource>.RegisterRef(e => e.Resource, ResourceIdProperty);
        ...
        /// </summary>
        [Label("产线编码")]
        public static readonly Property<string> ResourceCodeProperty = P<DesignerAreaReource>.RegisterView(e => e.ResourceCode, p => p.Resource.Code);
        ...
        /// </summary>
        [Label("产线名称")]
        public static readonly Property<string> ResourceNameProperty = P<DesignerAreaReource>.RegisterView(e => e.ResourceName, p => p.Resource.Name);
    ...
    internal class DesignerAreaReourceEntityConfig : EntityConfig<DesignerAreaReource>
    {
