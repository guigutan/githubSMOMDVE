...
namespace SIE.MES.DesignerAreas
{
    ...
    [Label("看板区域产线")]
    public class DesignerAreaResources : DataEntity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public DesignerAreaResources()
        {
        }
        ...
        public static readonly IRefIdProperty DesignerAreaIdProperty =
            P<DesignerAreaResources>.RegisterRefId(e => e.DesignerAreaId, ReferenceType.Parent);
    ...
    internal class DesignerAreaResourcesEntityConfig : EntityConfig<DesignerAreaResources>
    {
