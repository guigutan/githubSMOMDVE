...
namespace SIE.Wpf.MES.OnOffDutyA
{
    ...
    public partial class OnOffDutyAViewModel : DataCollectionViewModel<OnOffDutyController>
    {
        ...
        /// </summary>
        [Label("模块KEY")]
        public static readonly Property<string> ModuleKeyProperty = P<OnOffDutyAViewModel>.Register(e => e.ModuleKey);
        ...
        /// </summary>
        [Label("采集结果")]
        public static readonly ListProperty<OnOffDutyCollectDetailViewModelList> OnOffDutyCollectDetailViewModelListProperty = P<OnOffDutyAViewModel>.RegisterList(e => e.OnOffDutyCollectDetailViewModelList, new ListPropertyMeta
        {
            HasManyType = HasManyType.Aggregation,
            DataProvider = e => (e as OnOffDutyAViewModel).LoadOnOffDutyCollectDetailViewModelList()
        });
        ...
        /// </summary>
        [Label("是否上岗")]
        public static readonly Property<bool> IsOnDutyProperty = P<OnOffDutyAViewModel>.Register(e => e.IsOnDuty, new PropertyMetadata<bool>() { PropertyChangedCallBack = (o, e) => (o as OnOffDutyAViewModel).OnIsOffDuty(e) });
        ...
        protected virtual void AddDetail(OnOffDutyRecrodsA onOffDutyRecrods)
        {
