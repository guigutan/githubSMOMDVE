...
namespace SIE.Wpf.MES.OnOffDutyA
{
    ...
    /// 维修采集模板
    /// </summary>
    public class OnOffDutyAUITemplate : CollectionUITemplate
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public OnOffDutyAUITemplate() : base(typeof(OnOffDutyAViewModel))
        {
        }
        ...
        {
            var model = new OnOffDutyAViewModel { ModuleKey = ui.MainView.ModuleKey };
