...
{
    public class NewPackingQcViewModelViewConfig : WPFViewConfig<NewPackingQcViewModel>
    {
        /// <summary>
        /// 默认视图配置
        /// </summary>
        ...
        {
            View.UseCommands(typeof(NewCollectRestartCommand), typeof(NewNormalCommand), typeof(NewUnboxingCommand), typeof(NewBoxExChangeCommand), typeof(NewSubmitCommand),typeof(NewDeleteCommand));
