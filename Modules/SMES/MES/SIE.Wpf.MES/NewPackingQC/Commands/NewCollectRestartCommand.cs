...
namespace SIE.Wpf.MES.NewPackingQC.Commands
{
    /// <summary>
    /// 采集重新开始命令
    /// </summary>
    [Command(ImageName = "Refresh", Label = "重新开始", ToolTip = "重新开始", GroupType = CommandGroupType.Edit)]
    public class NewCollectRestartCommand : DetailViewCommand
    {
        /// <summary>
        /// 是否可执行的逻辑
        /// </summary>
        ...
        {
            return base.CanExecute(view) && (view.Current as DataCollectionViewModel) != null && (view.Current as NewPackingQcViewModel) != null;
        }
        ...
        public override void Execute(DetailLogicalView view)
        {
            ...
            vm.WorkOrderId = null;
            var vm1 = view.Current as NewPackingQcViewModel;
