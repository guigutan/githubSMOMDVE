...
namespace SIE.Wpf.MES.NewPackingQC
{
    ...
    /// 装箱QC
    /// </summary>
    public class NewPackingQcUITemplate : KZCollectionUITemplate
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public NewPackingQcUITemplate() : base(typeof(NewPackingQcViewModel))
        {
        ...
        {
            var model = new NewPackingQcViewModel();
