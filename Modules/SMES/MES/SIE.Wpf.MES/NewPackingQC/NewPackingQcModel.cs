...
namespace SIE.Wpf.MES.NewPackingQC
{
    ...
    [RootEntity]
    [Label("包装QC确认明细")]
    public class NewPackingQcModel : ViewModel
    {
        #region 蓝标 BlueLabel
        /// <summary>
        /// 蓝标
        ...
        [Required]
        [Label("蓝标")]
        public static readonly Property<string> BlueLabelProperty = P<NewPackingQcModel>.Register(e => e.BlueLabel);
        ...
        public static readonly IRefIdProperty ItemIdProperty =
            P<NewPackingQcModel>.RegisterRefId(e => e.ItemId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Item> ItemProperty =
            P<NewPackingQcModel>.RegisterRef(e => e.Item, ItemIdProperty);
        ...
        /// </summary>
        [Label("物料名称")]
        public static readonly Property<string> ItemNameProperty = P<NewPackingQcModel>.Register(e => e.ItemName);
        ...
        /// </summary>
        [Label("装箱标识")]
        public static readonly Property<PackIdentEnum?> PackIdentProperty = P<NewPackingQcModel>.Register(e => e.PackIdent);
        ...
        /// </summary>
        [Label("(QC)是否确认")]
        public static readonly Property<ConfirmEnum?> ConfirmProperty = P<NewPackingQcModel>.Register(e => e.Confirm);
        ...
        /// </summary>
        [Label("箱子状态")]
        public static readonly Property<BoxStateEnum?> BoxStateProperty = P<NewPackingQcModel>.Register(e => e.BoxState);
        ...
        /// </summary>
        [Label("蓝标数")]
        public static readonly Property<int> BlueLableNumProperty = P<NewPackingQcModel>.Register(e => e.BlueLableNum);
        ...
        /// </summary>
        [Label("装箱数量")]
        public static readonly Property<int> PackingNumProperty = P<NewPackingQcModel>.Register(e => e.PackingNum);
        ...
        public static readonly IRefIdProperty ResourceIdProperty =
            P<NewPackingQcModel>.RegisterRefId(e => e.ResourceId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<WipResource> ResourceProperty =
            P<NewPackingQcModel>.RegisterRef(e => e.Resource, ResourceIdProperty);
        ...
        /// </summary>
        [Label("工序标签")]
        public static readonly Property<string> ProductLabelProperty = P<NewPackingQcModel>.Register(e => e.ProductLabel);
