...
{
    public class NewPackingQcCUITemplate : KZCollectionUITemplate
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public NewPackingQcCUITemplate() : base(typeof(NewPackingQcCViewModel))
        {
        ...
        {
            var model = new NewPackingQcCViewModel();
