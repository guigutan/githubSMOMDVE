...
namespace SIE.Wpf.MES.WorkOrders
{
    ...
    /// ERP工单视图配置
    /// </summary>
    internal class ErpWorkOrderViewConfig : WPFViewConfig<ErpWorkOrder>
    {
        /// <summary>
        /// 默认视图配置
        /// </summary>
        ...
        protected override void ConfigListView()
        {
            ...
            View.Property(p => p.ErpSaleOrder).UsePagingLookUpEditor(p => p.DisplayMember = ErpSaleOrder.NoProperty.Name).HasLabel("ERP订单");
