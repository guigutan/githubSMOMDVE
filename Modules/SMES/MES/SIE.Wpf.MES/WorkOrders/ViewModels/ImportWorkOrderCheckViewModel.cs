...
namespace SIE.Wpf.MES.WorkOrders.ViewModels
{
    ...
    /// </summary>
    [RootEntity]
    public class ImportWorkOrderCheckViewModel : ViewModel
    {
        ...
        /// </summary>
        [Label("导入文件")]
        public static readonly Property<string> ImportFilePathProperty = P<ImportWorkOrderCheckViewModel>.Register(e => e.ImportFilePath);
        ...
        /// </summary>
        [Label("导入成功数量")]
        public static readonly Property<int> ImportSuccessAmountProperty = P<ImportWorkOrderCheckViewModel>.Register(e => e.ImportSuccessAmount);
        ...
        /// </summary>
        [Label("导入失败数量")]
        public static readonly Property<int> ImportFailAmountProperty = P<ImportWorkOrderCheckViewModel>.Register(e => e.ImportFailAmount);
        ...
        /// </summary>
        [Label("导入处理消息")]
        public static readonly Property<string> ImportProcessMsgProperty = P<ImportWorkOrderCheckViewModel>.Register(e => e.ImportProcessMsg);
        ...
        /// 导入工单数据集
        /// </summary>
        public static readonly ListProperty<EntityList<WorkOrderCheckDataViewModel>> ImportDataViewModelListProperty =
            P<ImportWorkOrderCheckViewModel>.RegisterList(e => e.ImportDataViewModelList, new ListPropertyMeta
            {
        ...
        /// 导入工单数据集
        /// </summary>
        public EntityList<WorkOrderCheckDataViewModel> ImportDataViewModelList
        {
    ...
    /// 工单导入ViewModel视图配置
    /// </summary>
    class ImportWorkOrderCheckViewModelConfig : WPFViewConfig<ImportWorkOrderCheckViewModel>
    {
        /// <summary>
        /// 默认视图
        /// </summary>
        ...
        protected override void ConfigDetailsView()
        {
            ...
            View.ClearCommands();
            View.UseCommands(typeof(DownloadWorkOrderCommand), typeof(ImportWorkOrderDataCommand));
