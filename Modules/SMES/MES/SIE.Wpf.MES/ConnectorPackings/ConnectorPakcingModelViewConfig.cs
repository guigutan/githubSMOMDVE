...
{
    public class ConnectorPakcingModelViewConfig : WPFViewConfig<ConnectorPackingViewModel>
    {
        /// <summary>
        /// 默认视图配置
        /// </summary>
        ...
        {
            View.UseCommands(typeof(ConnectorRestartCommand), typeof(ConnectorNormalCommand), typeof(ConnectorUnboxingCommand), typeof(ConnectorChangeCommand), typeof(ConnectorSubmitCommand),typeof(ConnectorSnDeleteCommand));
