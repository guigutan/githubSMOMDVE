...
namespace SIE.Wpf.MES.ConnectorPackings.Commands
{
    /// <summary>
    /// 提交
    /// </summary>
    [Command(ImageName = "", Label = "提  交", ToolTip = "提  交", GroupType = CommandGroupType.Edit)]
    public class ConnectorSubmitCommand : DetailViewCommand
    {
        /// <summary>
        /// 是否可执行的逻辑
        /// </summary>
        ...
        {
            return base.CanExecute(view) && (view.Current as DataCollectionViewModel) != null && (view.Current as ConnectorPackingViewModel) != null;
        }
        ...
        public override void Execute(DetailLogicalView view)
        {
            ...
            //包装采集信息
            var vm1 = view.Current as ConnectorPackingViewModel;
                ...
                if (result == MessageBoxResult.OK)
                {
                    ...
                    if (packingQc != null)
                    {
                        if (boolWork)
                        {
                            ...
                            submitMessage = RT.Service.Resolve<PackingQcController>().SubmitData(packingQc);
