...
{
    /// <summary>
    /// RepairDefectDutyControl.xaml 的交互逻辑
    /// </summary>
    public partial class RepairDefectDutyControl : UserControl
    {
        #region Data
        /// <summary>
        /// 所有缺陷责任
        ...
        public static readonly DependencyProperty SelectedValueProperty =
            DependencyProperty.Register("SelectedValue", typeof(ObservableCollection<DefectResponsibilityItem>), typeof(RepairDefectDutyControl), new PropertyMetadata(new ObservableCollection<DefectResponsibilityItem>(), (s, e) => { ((RepairDefectDutyControl)s).OnValueChanged(e); }));
        ...
        public static readonly DependencyProperty ResponsibilitiesProperty =
            DependencyProperty.Register("Defects", typeof(EntityList<DefectResponsibility>), typeof(RepairDefectDutyControl), new PropertyMetadata(new EntityList<DefectResponsibility>(), (s, e) => { ((RepairDefectDutyControl)s).OnDefectsChanged(e); }));
        ...
        /// 重新加载责任分类
        /// </summary>
        bool _reloadCategory = false;

        /// <summary>
        /// 构造函数
        /// </summary>
        public RepairDefectDutyControl()
        {
            InitializeComponent();
    ...
    public class DefectResponsibilityItem : ObservableObject
    {
        ...
        /// Control
        /// </summary>
        public RepairDefectDutyControl Control { get; set; }
