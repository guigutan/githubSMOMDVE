...
{
    /// <summary>
    /// RepairMeasureControl.xaml 的交互逻辑
    /// </summary>
    public partial class RepairMeasureControl : UserControl
    {
        /// <summary>
        /// 是否允许多选
        /// </summary>
        ...
        public static readonly DependencyProperty MeasuresProperty =
            DependencyProperty.Register("Measures", typeof(EntityList<RepairMeasure>), typeof(RepairMeasureControl), new PropertyMetadata(new EntityList<RepairMeasure>(), (s, e) => { ((RepairMeasureControl)s).OnMeasuresChanged(e); }));
        ...
        public static readonly DependencyProperty SelectedValuesProperty =
            DependencyProperty.Register("SelectedValues", typeof(EntityList<RepairMeasure>), typeof(RepairMeasureControl), new PropertyMetadata(new EntityList<RepairMeasure>(), (s, e) => { ((RepairMeasureControl)s).OnValuesChanged(e); }));
    ...
    public class MeasureItem : ObservableObject
    {
        ...
        /// Control
        /// </summary>
        public RepairMeasureControl Control { get; set; }
