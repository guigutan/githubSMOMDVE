...
{
    public class NewPackingQcDUITemplate : KZCollectionUITemplate
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public NewPackingQcDUITemplate() : base(typeof(NewPackingQcDViewModel))
        {
        ...
        {
            var model = new NewPackingQcDViewModel();
