...
namespace SIE.Wpf.MES.WIP.TemporaryRepairs
{
    ...
    public class TemporaryRepairDefectViewModelViewConfig : WPFViewConfig<TemporaryRepairDefectViewModel>
    {
        #region 维修措施 Measure
        /// <summary>
        /// 维修措施
        /// </summary>
        public static readonly Property<string> MeasureProperty = P<TemporaryRepairDefectViewModel>.RegisterExtensionReadOnly("Measure", typeof(TemporaryRepairDefectViewModelViewConfig),
            GetMeasure, TemporaryRepairDefectViewModel.MeasureListProperty);
        ...
        public static string GetMeasure(TemporaryRepairDefectViewModel me)
        {
        ...
        /// 缺陷责任
        /// </summary> 
        public static readonly Property<string> ResponsibilityProperty = P<TemporaryRepairDefectViewModel>.RegisterExtensionReadOnly("Responsibility", typeof(TemporaryRepairDefectViewModelViewConfig),
            GetResponsibility, TemporaryRepairDefectViewModel.ResponsibilityListProperty);
        ...
        public static string GetResponsibility(TemporaryRepairDefectViewModel me)
        {
        ...
        {
            View.AssignAuthorize(typeof(TemporaryRepairViewModel));
            View.UseCommands(typeof(TemporaryRepairCommand), typeof(AddDefectCommand), typeof(DeleteDefectCommand));
