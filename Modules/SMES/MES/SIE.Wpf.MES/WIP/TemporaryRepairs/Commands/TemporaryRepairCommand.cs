...
namespace SIE.Wpf.MES.WIP.TemporaryRepairs.Commands
{
    ...
    public class TemporaryRepairCommand : ListViewCommand
    {
        /// <summary>
        /// 判断维修命令能否执行
        /// </summary>
        ...
        {
            var defect = view.Current as TemporaryRepairDefectViewModel;
        ...
        /// <returns>控件</returns>
        private DockPanel CreateControl(TemporaryRepairDefectViewModel defect)
        {
            var moduleKey = RT.Service.Resolve<IFindModule>().FindModuleKey(typeof(TemporaryRepairViewModel));
            var panel = new DockPanel();
            var detailView = AutoUI.ViewFactory.CreateDetailView(typeof(TemporaryRepairDefectViewModel), TemporaryRepairDefectViewModelViewConfig.RepairView, moduleKey);
        ...
        private void BindingData(TemporaryRepairDefectViewModel defect, MeasureControl measureEditor, ResponsibilityControl editor)
        {
