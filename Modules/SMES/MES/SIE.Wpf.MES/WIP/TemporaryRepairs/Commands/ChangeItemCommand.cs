...
namespace SIE.Wpf.MES.WIP.TemporaryRepairs.Commands
{
    ...
    public class ChangeItemCommand : ListViewCommand
    {
        ...
        public override bool CanExecute(ListLogicalView view)
        {
            ...
            return view.Current != null && mainView?.Current != null && mainView.Current is TemporaryRepairViewModel;
        }
        ...
        {
            var repair = view.Relations.Find("mainView").Current.CastTo<TemporaryRepairViewModel>();
                ...
                if (loadItems.Any())
                {
                    ...
                    try
                    {
                        ...
                        var barcodeInfo = new LoadItemBarcodeInfo()
                        {
                            ...
                            WipWorkOrderId= repair.WorkOrderId.Value
                        };
                        ...
                        if (!assembly.ChangeItemViewModelList.Any(p => p.ChangeSn == loadItem.SourceCode))
                        {
                            ChangeItemViewModel changeItemViewModel = new ChangeItemViewModel()
                            {
                                ...
                                ChangeQty = loadItem.Qty >= assembly.KeyItem.Qty ? assembly.KeyItem.Qty : loadItem.Qty,
                            ...
                            assembly.TotalChangeQty = changeItemViewModel.ChangeQty;
                        }
                    }
                    catch (Exception ex)
                    {
