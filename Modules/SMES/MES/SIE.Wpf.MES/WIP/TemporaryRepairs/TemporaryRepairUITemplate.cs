...
namespace SIE.Wpf.MES.WIP.TemporaryRepairs
{
    ...
    /// 维修采集模板
    /// </summary>
    public class TemporaryRepairUITemplate : CollectionUITemplate
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public TemporaryRepairUITemplate() : base(typeof(TemporaryRepairViewModel))
        {
        }
        ...
        {
            var model = new TemporaryRepairViewModel { ModuleKey = ui.MainView.ModuleKey };
        ...
        FrameworkElement CreateDefectControl(LogicalView mainView, EntityList<TemporaryRepairDefectViewModel> defectList, EntityList<ProductAssemblyDetailViewModel> details)
        {
            var panel = new Grid();
