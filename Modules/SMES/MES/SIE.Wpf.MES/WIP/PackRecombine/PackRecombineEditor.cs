...
namespace SIE.Wpf.MES.WIP.PackRecombine
{
    ...
    /// 工单明细弹框编辑器
    /// </summary>
    public class PackRecombineEditor : TextEditor
    {
        /// <summary>
        /// 工单明细编辑器名称
        /// </summary>
        public const string EditorName = "PackRecombineEditor";
        ...
        protected override FrameworkElement CreateEditingElement()
        {
            ...
            button.Click += (s, e) =>
            {
                var m = Context.CurrentObject as PackRecombineBaseViewModel;
