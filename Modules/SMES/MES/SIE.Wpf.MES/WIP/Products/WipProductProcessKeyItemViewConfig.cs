...
namespace SIE.Wpf.MES.WIP.Products
{
    ...
    /// 产品生产关键件视图配置
    /// </summary>
    internal class WipProductProcessKeyItemViewConfig : WPFViewConfig<WipProductProcessKeyItem>
    {
        /// <summary>
        /// 配置列表视图
        /// </summary>
        protected override void ConfigListView()
        {
            ...
            View.Property(p => p.CreateDate).HasLabel("操作时间").Readonly().ShowInList(gridWidth: 150);
