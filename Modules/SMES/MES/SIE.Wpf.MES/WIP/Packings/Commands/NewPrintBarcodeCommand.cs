...
namespace SIE.Wpf.MES.WIP.Packings.Commands
{
    ...
    public class NewPrintBarcodeCommand : ListViewCommand
    {
        readonly ILog logger = LogManager.GetLogger("wip");
        /// <summary>
        /// 未打印抛出异常
        /// </summary>
        public readonly static string NotPrintThrowException = "NotPrintThrowException";

        /// <summary>
        /// 允许叠加
        /// </summary>
        public readonly static string EnableMultiple = "EnableMultiple";

        /// <summary>
        /// 包装ViewModel
        /// </summary>
        private NewPackingViewModel ViewModel => View.Parent.Current as NewPackingViewModel;
        ...
        public override void Execute(ListLogicalView view)
        {
            ...
            using (PerformenceWatcher.Start(logger, "NewPrintBarcodeCommand"))
            {
