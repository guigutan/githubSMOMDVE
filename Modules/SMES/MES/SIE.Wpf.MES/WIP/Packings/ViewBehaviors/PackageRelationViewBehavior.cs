...
namespace SIE.Wpf.MES.WIP.Packings.ViewBehaviors
{
    ...
    /// 包装关系视图行为
    /// </summary>
    public class PackageRelationViewBehavior : ViewBehavior
    {
        /// <summary>
        /// 附加行为
        /// </summary>
        ...
        private void PackageRelation_RowDoubleClick(object sender, RowDoubleClickEventArgs e)
        {
            var packingViewData = View.Parent?.Current as PackingViewModel;
            var packingRelation = View.Current as PackingRelation;
            if (packingViewData == null) return;
            packingViewData.ResetPacking();
            packingViewData.OuterPackingRelation = packingRelation;
            packingViewData.Error = string.Empty;
            packingViewData.Barcode = string.Empty;
            packingViewData.ScanMode = SIE.MES.WIP.Packings.ScanMode.Join;
            packingViewData.ShowTips();
        }
