...
namespace SIE.Wpf.MES.WIP.Repairs
{
    ...
    /// 维修采集视图配置
    /// </summary>
    public class RepairViewModelViewConfig : WPFViewConfig<RepairViewModel>
    {
        /// <summary>
        /// 配置视图
        /// </summary>
        protected override void ConfigView()
        {
            ...
            View.UseCommands(typeof(CollectRestartCommand), typeof(SaveRepairRecord), typeof(RepairSubmitCommand), typeof(SubmitCommand), typeof(ChangeWorkOrderCommand), typeof(CollectProjectCardCommand));
