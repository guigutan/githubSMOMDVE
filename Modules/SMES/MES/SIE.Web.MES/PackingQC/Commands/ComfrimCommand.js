SIE.defineCommand('SIE.Web.MES.PackingQC.Commands.ComfrimCommand', {
    ...
    execute: function (view, source) {
        ...
        debugger;
        var me = this;
        var children = view.getCurrent();
        var childrenData = children.data;
        //var prepareRecordDetail = [];
        //if (childrenData) {
        //    childrenData.forEach(function (item) {
        //        prepareRecordDetail.push(item);
        //    });
        //}
        var indata = Ext.encode(childrenData);
        console.log(indata);
        view.execute({
            data: childrenData,
