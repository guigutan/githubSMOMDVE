SIE.defineCommand('SIE.Web.MES.Projects.Commands.ProcessStandExportCommand', {
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    SIE.invokeDataQuery({
                        ...
                        action: 'queryer',
                        type: 'SIE.Web.MES.Projects.DataQueryers.ProcessStandardQueryer',
                        token: token,
                        logInfo: signdata,
                        success: function (res) {
                            ...
                            me.table2Excel(div, catearr, "工序标准参数".t() + datestr + ".xls", "Excel");
