SIE.defineCommand('SIE.Web.MES.WIP.Pressure.Commands.WipPressurePrintTPLDLTemplateCommand', {
    ...
    */
    createExportParam: function (view) {
        var me = this;
        var param = {
            Name: "SIE.Web.MES.WIP.Pressure.Commands.WipPressurePrintTPLImportCommand",
            Token: view.getToken(),
