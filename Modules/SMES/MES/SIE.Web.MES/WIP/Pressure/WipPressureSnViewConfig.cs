...
namespace SIE.Web.MES.WIP.Pressure
{
    ...
    /// 视图配置
    /// </summary>
    internal class WipPressureSnViewConfig : WebViewConfig<WipPressureSn>
    {
        /// <summary>
        /// 配置列表视图
        /// </summary>
        protected override void ConfigListView()
        {
            ...
            using (View.OrderProperties())
            {
                ...
                View.Property(p => p.RawData).ShowInList(250).Readonly();
                View.Property(p => p.IsOver).ShowInList().Readonly();
                View.Property(p => p.Sn2).ShowInList(200).Readonly();
                ...
                View.ChildrenProperty(p => p.TestValueList).HasLabel("测试结果");
