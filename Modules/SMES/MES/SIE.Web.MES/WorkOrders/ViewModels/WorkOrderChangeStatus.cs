...
namespace SIE.Web.MES.WorkOrders.ViewModels
{
    ...
    public class WorkOrderChangeStatus : ViewModel
    {
        ...
        private string GetIsPause()
        {
            if (WorkOrder == null)
                return string.Empty;
            return WorkOrder.IsPause.ToLabel().L10N();
        }
        #endregion
        ...
        /// </summary>
        [Label("工单Id")]
        public static readonly Property<double> WorkOrderIdProperty = P<WorkOrderChangeStatus>.Register(e => e.WorkOrderId);
        ...
        /// </summary>
        [Label("工单号")]
        public static readonly Property<string> WorkOrderNoProperty = P<WorkOrderChangeStatus>.Register(e => e.WorkOrderNo);
    ...
    /// 工单改变状态ViewModel视图配置
    /// </summary>
    internal class WorkOrderChangeStatusViewModelViewConfig : WebViewConfig<WorkOrderChangeStatus>
    {
        /// <summary>
        /// 通用视图配置
        /// </summary>
        ...
        {
            View.RequierModels(typeof(WorkOrderChangeStatus));
            using (View.OrderProperties())
            {
                View.Property(p => p.WorkOrderNo).HasLabel("工单号").ShowInDetail().Readonly();
                View.Property(p => p.IsPause).ShowInDetail().Readonly();
                View.Property(p => p.State).ShowInDetail().Readonly();
