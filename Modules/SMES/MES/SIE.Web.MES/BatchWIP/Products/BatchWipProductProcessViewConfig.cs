...
namespace SIE.Web.MES.BatchWIP.Products
{
    ...
    /// 批次采集记录视图配置
    /// </summary>
    internal class BatchWipProductProcessViewConfig : WebViewConfig<BatchWipProductProcess>
    {
        ///<summary>
        /// 配置列表视图
        /// </summary>
        ...
        {
            View.AddBehavior("SIE.Web.MES.BatchWip.BatchWipProductProcessBehavior");
