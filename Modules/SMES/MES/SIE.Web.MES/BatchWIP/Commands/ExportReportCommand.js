SIE.defineCommand('SIE.Web.MES.BatchWIP.Products.ExportReportCommand', {
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    SIE.invokeDataQuery({
                        ...
                        action: 'queryer',
                        type: 'SIE.Web.MES.BatchWIP.Products.BatchWipProductDataQueryer',
                        token: token,
                        logInfo: signdata,
                        success: function (res) {
                            ...
                            me.table2Excel(div, catearr, "批次生产通用报表".t() + datestr + ".xls", "Excel");
