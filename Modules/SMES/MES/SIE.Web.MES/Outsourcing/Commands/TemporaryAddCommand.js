SIE.defineCommand('SIE.Web.MES.Outsourcing.Commands.TemporaryAddCommand', {
    extend: 'SIE.cmd.Add',
    meta: { text: "添加临时委外", group: "edit" },

    execute: function (view, source) {
        var me = this;
        SIE.AutoUI.getMeta({
            model: "SIE.MES.Outsourcing.Model.TemporaryAddModel",
            ...
            callback: function (res) {
                ...
                var entity = Ext.create("SIE.MES.Outsourcing.Model.TemporaryAddModel");
                            ...
                            SIE.invokeDataQuery({
                                ...
                                callback: function (res) {
                                    if (!res.Success) {
                                        ...
                                        SIE.Msg.showInstantMessage(res.Result, "提示".t(), 2, function () { win.close(); });
