SIE.defineCommand('SIE.Web.MES.Outsourcing.Commands.OutboundAddCommand', {
    extend: 'SIE.cmd.Edit',
    meta: { text: "添加可出库在制品", group: "business", iconCls: "icon-AddEntity icon-green" },
