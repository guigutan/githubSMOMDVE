SIE.defineCommand('SIE.Web.MES.ItemEquipAccount.Commands.EquipAccountItemDLTemplateCommand', {
    ...
    */
    createExportParam: function (view) {
        var me = this;
        var param = {
            Name: "SIE.Web.MES.ItemEquipAccount.Commands.EquipAccountItemImportCommand",
            Token: view.getToken(),
