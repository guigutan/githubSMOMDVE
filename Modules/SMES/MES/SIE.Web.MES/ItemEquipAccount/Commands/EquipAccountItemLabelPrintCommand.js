SIE.defineCommand('SIE.Web.MES.ItemEquipAccount.Commands.EquipAccountItemLabelPrintCommand', {
    meta: { text: "模具条码化打印", group: "edit", iconCls: "icon-PrintData icon-blue" },
    ...
    execute: function (view, source) {
        ...
        SIE.AutoUI.getMeta({
            model: "SIE.Web.MES.ItemEquipAccount.ViewModels.EquipAccountItemViewModels",
                                    ...
                                    if (rstPrint.ErrMsg !== '') {
                                        ...
                                        if (cfg && cfg.printCallback) {
                                            ...
                                            if (!printCmpt.hasError()) {
                                                ...
                                                if (!printCmpt.hasError())
                                                    CRT.Workbench.showPageDialog({ id: 'ReprintBatch_rpt', text: "模具条码化打印".t(), method: 'POST', url: printUrl, params: param });
                                            }
                                        }
