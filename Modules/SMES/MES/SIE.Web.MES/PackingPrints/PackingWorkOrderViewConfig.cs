...
namespace SIE.Web.MES.PackingPrints
{
    ...
    /// 包装条码打印视图
    /// </summary>
    internal class PackingWorkOrderViewConfig : WebViewConfig<PackingWorkOrder>
    {
        /// <summary>
        /// 包装条码打印视图
        /// </summary>
        ...
        {
            View.FormEdit();
            View.UseCommands("SIE.Web.MES.PackingPrints.Commands.PackingBarcodePrintCommand");
            using (View.OrderProperties())
            {
                View.Property(p => p.No).HasLabel("工单号").Readonly().ShowInList(180);
                ...
                View.Property(p => p.PanelQty).Readonly().Show(ShowInWhere.Hide);
                ...
                View.ChildrenProperty(p => p.WorkOrderOutputProductList).Show(ChildShowInWhere.Hide).HasLabel("联副产品关系");
