SIE.defineCommand('SIE.Web.MES.ProductAgingProcesss.Commands.ProductAgingProcessTemplateCommand', {
    ...
    */
    createExportParam: function (view) {
        var me = this;
        var param = {
            Name: "SIE.Web.MES.ProductAgingProcesss.Commands.ProductAgingProcessImportCommand",
            Token: view.getToken(),
