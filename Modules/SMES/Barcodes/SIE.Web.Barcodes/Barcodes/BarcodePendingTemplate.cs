...
namespace SIE.Web.Barcodes
{
    ...
    /// 条码挂起模板
    /// </summary>
    public class BarcodePendingTemplate : CodeBlocksTemplate
    {
        /// <summary> 
        /// 定义查询块
        /// </summary>
        ...
        protected override void DefineQueryBlocks(EntityMeta entityMeta, AggtBlocks aggtBlocks)
        {
            ...
            if (entityMeta.EntityType == typeof(BarcodePending))
            {
                var conditionBlock = new ConditionBlock(typeof(BarcodeCriteria), BarcodeViewConfig.PendingView);
