SIE.defineCommand('SIE.Web.Barcodes.ReprintCommand', {
                                                    ...
                                                    if (rstPrint.ErrMsg !== '') {
                                                        ...
                                                        if (cfg && cfg.printCallback) {
                                                            ...
                                                            if (!printCmpt.hasError()) {
                                                                ...
                                                                if (!printCmpt.hasError())
                                                                    //printers("siedev", "条码补打".t(), param.content);       
                                                                    CRT.Workbench.showPageDialog({ id: 'LotReprint_rpt', text: "条码补打".t(), method: 'POST', url: printUrl, params: param });
                                                            }
                                                        }
