...
namespace SIE.Barcodes
{
    ...
    [Label("工单条码打印查询实体")]
    public class PrintWorkOrderCriteria : WorkOrderCriteria
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public PrintWorkOrderCriteria()
        {
        ...
        /// </summary>
        [Label("创建时间")]
        public static readonly Property<DateRange> CreateDateProperty = P<PrintWorkOrderCriteria>.Register(e => e.CreateDate);
        ...
        public static readonly IRefIdProperty CreateByIdProperty =
           P<PrintWorkOrderCriteria>.RegisterRefId(e => e.CreateById, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Employee> CreateByProperty =
            P<PrintWorkOrderCriteria>.RegisterRef(e => e.CreateBy, CreateByIdProperty);
        ...
        {
            return RT.Service.Resolve<BarcodeController>().GetWorkOrders(this);
        }
    }
}