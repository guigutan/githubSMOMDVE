...
namespace SIE.Web.MES.DashBoard.Reports.ShopFPY
{
    ...
    public class ShopRateInfo
    {
        ...
        /// 折线图信息列表
        /// </summary>
        public List<ShopChartInfo> ShopChartInfoList { get; } = new List<ShopChartInfo>();

        /// <summary>
        /// 折线图目标\警告设置信息列表
        /// </summary>
        public ShopChartSettingInfo ShopChartSettingInfo { get; set; } = new ShopChartSettingInfo();
    }
    ...
    /// 折线图目标\警告设置信息
    /// </summary>
    public class ShopChartSettingInfo
    {
        /// <summary>
        /// 资源名称
        /// </summary>
