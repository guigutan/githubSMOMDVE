...
namespace SIE.Web.MES.DashBoard.Reports.ProductFPY
{
    ...
    /// 产线直通率信息
    /// </summary>
    public class ProductionProductRateInfo
    {
        /// <summary>
        /// 机型
        /// </summary>
        ...
        /// 折线图信息列表
        /// </summary>
        public List<ProductChartInfo> ProductChartInfoList { get; } = new List<ProductChartInfo>();

        /// <summary>
        /// 折线图目标\警告设置信息列表
        /// </summary>
        public ProductChartSettingInfo ProductChartSettingInfo { get; set; } = new ProductChartSettingInfo();
    }
    ...
    /// 折线图目标\警告设置信息
    /// </summary>
    public class ProductChartSettingInfo
    {
        /// <summary>
        /// 资源名称
        /// </summary>
