SIE.defineCommand('SIE.Web.MES.DashBoard.WorkOrderReachs.Commands.WoReachExport', {
            ...
            success: function (res) {
                ...
                if (exportData == "") {
                    ...
                    SIE.Signature.otherCheckIsNeedToSign("导出Excel", view, function () {
                        ...
                        debugger;
                        SIE.Web.MES.CommonFuns.tablesToExcel(div.children, ['工单准时达成率'], "工单准时达成率.xls".t(), "Excel");
