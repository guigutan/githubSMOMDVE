SIE.defineCommand('SIE.Web.MES.DashBoard.ProductionProcesss.Commands.ProductionProcessDLTemplateCommand', {
    ...
    */
    createExportParam: function (view) {
        var me = this;
        var param = {
            Name: "SIE.Web.MES.DashBoard.ProductionProcesss.Commands.ProductionProcessImportCommand",
            Token: view.getToken(),
