...
namespace SIE.Wpf.MES.DashBoard.Reports.FpySettings
{
    ...
    public class ShopFpySettingCriteriaViewConfig : WPFViewConfig<ShopFpySettingCriteria>
    {
        ...
        protected override void ConfigView()
        {
            ...
            }).UsePagingLookUpEditor(p => { p.ReloadDataOnPopping = true; }).Show().Readonly(ClearLineProperty);
        }
    }
}