    ...
    public partial class DashBoardShopToLineLookupEdit : UserControl
    {
        ...
        public DashBoardShopToLineLookupEdit()
        {
            ...
            this.Loaded += (o, e) =>
            {
                ...
                else
                {
                    ...
                    var srcType = new List<SyncSourceType>() { SyncSourceType.Enterprise };
                    this.lineLookupEdit.ItemsSource = RT.Service.Resolve<WipResourceController>().GetWipResources(stateList, ShopAndLine.Shop.Value, srcType, null, null);
                }
        ...
        private void ShopAndLine_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == "Shop")
            {
                ...
                {
                    var stateList = new List<ResourceState>() { ResourceState.Actived, ResourceState.Stop, ResourceState.Unused };
                    var typeList = new List<SyncSourceType>() { SyncSourceType.Enterprise };
                    this.lineLookupEdit.ItemsSource = RT.Service.Resolve<WipResourceController>().GetWipResources(stateList, ShopAndLine.Shop.Value, typeList, null, null);
                }
            }
        }
    }
