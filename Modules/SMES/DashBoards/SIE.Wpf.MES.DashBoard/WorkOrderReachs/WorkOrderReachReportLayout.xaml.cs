...
namespace SIE.Wpf.MES.DashBoard.WorkOrderReachs
{
    ...
    /// </summary>
    public partial class WorkOrderReachReportLayout : UserControl, ILayoutControl
    {
        /// <summary>
        /// 直通率报表通用控件
        /// </summary>
        WorkOrderReachPivotGridControl _reportControl;

        /// <summary>
        /// 构造函数
        /// </summary>
        public WorkOrderReachReportLayout()
        {
            InitializeComponent();
        }
        ...
        public virtual void Arrange(UIComponents components)
        {
            ...
            _reportControl = new WorkOrderReachPivotGridControl();
