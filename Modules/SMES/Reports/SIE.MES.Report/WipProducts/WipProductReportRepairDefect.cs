...
namespace SIE.MES.Report.WipProducts
{
    ...
    [Label("产品维修记录缺陷")]
    public partial class WipProductReportRepairDefect : WipProductRepairDefect
    {
        ...
        public static new readonly IRefIdProperty WipProductRepairIdProperty =
            P<WipProductReportRepairDefect>.RegisterRefId(e => e.WipProductRepairId, ReferenceType.Parent);
        ...
        public static new readonly RefEntityProperty<WipProductReportRepair> WipProductRepairProperty =
            P<WipProductReportRepairDefect>.RegisterRef(e => e.WipProductRepair, WipProductRepairIdProperty);
