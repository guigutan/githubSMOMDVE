...
namespace SIE.Web.MES.Report.EmployeeReports
{
    ...
    public class EmployeeClockInAttentReportViewConfig : WebViewConfig<EmployeeClockInAttentReport>
    {
        /// <summary>
        ///  出勤工时统计
        /// </summary>
        ...
        ///  出勤工时统计报表
        /// </summary>
        public const string AttentReportViewGroup = "AttentReportViewGroup";
        ...
        {
            View.DeclareExtendViewGroup(AttentReportViewGroup);
            if (ViewGroup == AttentReportViewGroup)
                AttentTimeView();
        }
        ...
        {
            View.RequirModuleResource("SIE.Web.MES.TeamManagement.ClockingIns.Scripts.SetClockInStateStyle.js");
            ...
            using (View.OrderProperties())
            {
                ...
                View.AttachChildrenProperty(typeof(WorkGroupOnLoanReport), (o) =>
                {
                    var args = o as ChildPagingDataArgs;
                    var entity = args.Parent as EmployeeClockInAttentReport;
                    entity = RF.GetById<EmployeeClockInAttentReport>(entity.Id);
                    var rst = RT.Service.Resolve<EmployeeReportController>().GetWorkGroupOnLoanByEmp(entity.EmployeeId, entity.ClockInDate, args.PagingInfo);
                    return rst;
