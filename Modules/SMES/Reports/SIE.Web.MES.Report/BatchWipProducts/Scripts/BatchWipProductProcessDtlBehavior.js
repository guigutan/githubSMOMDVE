Ext.define("SIE.Web.MES.Report.BatchWipProducts.BatchWipProductProcessDtlBehavior", {
    outputView: null,
    ...
    currentChanged: function () {
        var me = this;
        if (me.view && me.view.getCurrent() !== null) {
            if (!me.outputView)
                me.getOutputView();
            if (me.outputView)
    ...
    getOutputView: function () {
        var me = this;
        me.outputView = me.view._children.first(function (child) { return child.model === 'SIE.MES.Report.BatchWipProducts.BatchWipProductProcessDetailReport' });
    }
});