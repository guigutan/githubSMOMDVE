...
namespace SIE.Wpf.ProductIntfc.FirstInsps
{
    ...
    internal class FirstInspCriteriaViewConfig : WPFViewConfig<FirstInspCriteria>
    {
        #region 清除资源 ClearResource
        /// <summary>
        /// 清除资源
        /// </summary> 
        public static readonly Property<bool> ClearResourceProperty = P<FirstInspCriteria>.RegisterExtensionReadOnly("ClearResource", typeof(FirstInspCriteriaViewConfig),
            GetClearResource, FirstInspCriteria.ShopIdProperty);
        ...
        public static bool GetClearResource(FirstInspCriteria me)
        {
            me.Resource = null;
            return false;
        }
        ...
        protected override void ConfigView()
        {
            using (View.OrderProperties())
            {
                ...
                {
                    var criteria = e as FirstInspCriteria;
