...
namespace SIE.ProductIntfc.Configs
{
    ...
    public class FirstInspNoConfigValue : ConfigValue
    {
        ...
        public static readonly IRefIdProperty NumberRuleIdProperty =
            P<FirstInspNoConfigValue>.RegisterRefId(e => e.NumberRuleId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<NumberRule> NumberRuleProperty =
            P<FirstInspNoConfigValue>.RegisterRef(e => e.NumberRule, NumberRuleIdProperty);
