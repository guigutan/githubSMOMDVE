...
namespace SIE.ERPInterface.Job.Download.ProductBoms
{
    ...
    /// 产品Bom下载
    /// </summary>
    [Job("产品Bom下载", typeof(DLCommonParameter))]
    public class DownloadProductBomJob : JobBase
    {
        /// <summary>
        /// 执行调度
        /// </summary>
        ...
        protected override void ExecuteJob(object param)
        {
            ...
            {
                var resultInf = RT.Service.Resolve<SoapProductBomController>().DownloadToInf();                     //执行中间表下载
                AddLog("中间表结束下载{0}".L10nFormat(resultInf == null ? "。" : "，" + resultInf.Msg));
            }

            var resultSmom = RT.Service.Resolve<DownloadProductBomController>().DownloadProductBomInfToBusiness();           //执行业务表下载
