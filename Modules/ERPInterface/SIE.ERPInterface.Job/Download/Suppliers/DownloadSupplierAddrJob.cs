...
namespace SIE.ERPInterface.Job.Download.Suppliers
{
    ...
    /// 供应商地址下载
    /// </summary>
    [Job("供应商地址下载", typeof(DLCommonParameter))]
    public class DownloadSupplierAddrJob : JobBase
    {
        /// <summary>
        /// 执行调度
        /// </summary>
        ...
        protected override void ExecuteJob(object param)
        {
            ...
            var resultSmom = RT.Service.Resolve<DownloadSupplierAddrController>().DownloadSupplierAddrInfToBusiness();           //执行业务表下载
