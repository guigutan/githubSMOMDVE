...
namespace SIE.ERPInterface.Job.Upload
{
    ...
    /// 来料接收事务上传
    /// </summary>
    [Job("来料接收事务上传", typeof(JobParameter))]
    public class UploadReceiveJob : JobBase
    {
        /// <summary>
        /// 执行调度
        /// </summary>
        ...
        protected override void ExecuteJob(object param)
        {
            ...
            {
                tuples.Add(new Tuple<OrderType, TransactionType, double?, string>(OrderType.PurchaseIn, TransactionType.Receive,null,""));       //没有配置规则，默认事务定义
