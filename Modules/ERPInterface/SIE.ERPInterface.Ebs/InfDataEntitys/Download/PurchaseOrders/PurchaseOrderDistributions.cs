...
namespace SIE.ERPInterface.EBS.InfDataEntitys.Download
{
    ...
    //[CriteriaQuery]
    [Label("采购订单分配行")]
    public partial class PurchaseOrderDistributions : DataEntity
    {
        ...
        /// </summary>
        [Label("采购订单ERPID")]
        public static readonly Property<string> PoErpIdProperty = P<PurchaseOrderDistributions>.Register(e => e.PoErpId);
        ...
        /// </summary>
        [Label("采购订单行ERPID")]
        public static readonly Property<string> PoLineErpIdProperty = P<PurchaseOrderDistributions>.Register(e => e.PoLineErpId);
        ...
        /// </summary>
        [Label("采购订单号")]
        public static readonly Property<string> PoNoProperty = P<PurchaseOrderDistributions>.Register(e => e.PoNo);
        ...
        /// </summary>
        [Label("采购订单行号")]
        public static readonly Property<string> PoLineNoProperty = P<PurchaseOrderDistributions>.Register(e => e.PoLineNo);
        ...
        /// </summary>
        [Label("采购订单发运行ERPID")]
        public static readonly Property<string> LineLocationErpIdProperty = P<PurchaseOrderDistributions>.Register(e => e.LineLocationErpId);
        ...
        /// </summary>
        [Label("采购订单发运行号")]
        public static readonly Property<string> LineLocationNoProperty = P<PurchaseOrderDistributions>.Register(e => e.LineLocationNo);
        ...
        /// </summary>
        [Label("来源分配ID")]
        public static readonly Property<int> PoReleaseIdProperty = P<PurchaseOrderDistributions>.Register(e => e.PoReleaseId);
        ...
        /// </summary>
        [Label("采购申请单分配ID")]
        public static readonly Property<int?> DeliverToLocationIdProperty = P<PurchaseOrderDistributions>.Register(e => e.DeliverToLocationId);
        ...
        /// </summary>
        [Label("收货人")]
        public static readonly Property<int?> DeliverToPersonIdProperty = P<PurchaseOrderDistributions>.Register(e => e.DeliverToPersonId);
        ...
        /// </summary>
        [Label("数量")]
        public static readonly Property<decimal> QuantityOrderedProperty = P<PurchaseOrderDistributions>.Register(e => e.QuantityOrdered);
        ...
        /// </summary>
        [Label("已交货数量")]
        public static readonly Property<decimal> QuantityDeliveredProperty = P<PurchaseOrderDistributions>.Register(e => e.QuantityDelivered);
        ...
        /// </summary>
        [Label("开票数量")]
        public static readonly Property<decimal> QuantityBilledProperty = P<PurchaseOrderDistributions>.Register(e => e.QuantityBilled);
        ...
        /// </summary>
        [Label("取消数量")]
        public static readonly Property<decimal> QuantityCancelledProperty = P<PurchaseOrderDistributions>.Register(e => e.QuantityCancelled);
        ...
        /// </summary>
        [Label("帐套ID")]
        public static readonly Property<string> SetOfBooksIdProperty = P<PurchaseOrderDistributions>.Register(e => e.SetOfBooksId);
        ...
        /// </summary>
        [Label("汇率")]
        public static readonly Property<double?> RateProperty = P<PurchaseOrderDistributions>.Register(e => e.Rate);
        ...
        /// </summary>
        [Label("汇率日期")]
        public static readonly Property<DateTime?> RateDateProperty = P<PurchaseOrderDistributions>.Register(e => e.RateDate);
        ...
        /// </summary>
        [Label("负担标志")]
        public static readonly Property<string> EncumberedFlagProperty = P<PurchaseOrderDistributions>.Register(e => e.EncumberedFlag);
        ...
        /// </summary>
        [Label("外协工单号")]
        public static readonly Property<string> WoNoProperty = P<PurchaseOrderDistributions>.Register(e => e.WoNo);
        ...
        /// </summary>
        [Label("外协工单ERPID")]
        public static readonly Property<string> WoErpIdProperty = P<PurchaseOrderDistributions>.Register(e => e.WoErpId);
        ...
        /// </summary>
        [Label("工序")]
        public static readonly Property<string> WipOperationSeqNumProperty = P<PurchaseOrderDistributions>.Register(e => e.WipOperationSeqNum);
        ...
        /// </summary>
        [Label("工序序号")]
        public static readonly Property<string> WipResourceSeqNumProperty = P<PurchaseOrderDistributions>.Register(e => e.WipResourceSeqNum);
        ...
        /// </summary>
        [Label("更新人编码")]
        public static readonly Property<string> UpdateByCodeProperty = P<PurchaseOrderDistributions>.Register(e => e.UpdateByCode);
        ...
        /// </summary>
        [Label("ERP ID")]
        public static readonly Property<string> ErpIdProperty = P<PurchaseOrderDistributions>.Register(e => e.ErpId);
    ...
    /// 采购订单分配行 实体配置
    /// </summary>
    internal class PurchaseOrderDistributionsConfig : EntityConfig<PurchaseOrderDistributions>
    {
        /// <summary>
        /// 配置元数据
        /// </summary>
        ...
        {
            Meta.MapTable("PO_DIS").MapAllProperties();
            Meta.EnablePhantoms();
        }
    }
}