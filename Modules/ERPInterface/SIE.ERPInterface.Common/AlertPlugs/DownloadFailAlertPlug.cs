...
namespace SIE.ERPInterface.Common.AlertPlugs
{
    ...
    [Alert("ERP接口调度下载失败预警", typeof(DownloadFailAlertPlugConfig), typeof(StringAlertResult), "ERP接口调度下载失败预警")]
    public class DownloadFailAlertPlug : AlertBase
    {
        /// <summary>
        /// 执行
        /// </summary>
        ...
        public override AlertResultBase Run()
        {
            ...
            var dataStatistics = RT.Service.Resolve<InterfaceAlertController>().GetDownloadFailStatistics(beginDate, endDate);
