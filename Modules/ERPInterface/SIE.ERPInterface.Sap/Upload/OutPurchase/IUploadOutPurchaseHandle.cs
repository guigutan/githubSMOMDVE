...
namespace SIE.ERPInterface.Sap.Upload.OutPurchase
{
    ...
    /// 委外出库事务上传
    /// </summary>
    internal class IUploadOutPurchaseHandle : IUploadDataHandler<SapOrderParamOutPur<UploadOutPurchaseData>>
    {
        ...
        /// <returns></returns>
        SapUploadParam<SapOrderParamOutPur<UploadOutPurchaseData>> IUploadDataHandler<SapOrderParamOutPur<UploadOutPurchaseData>>.SetUploadData(List<UploadTransaction> uploadTransactions)
        {
            var rst = new SapUploadParam<SapOrderParamOutPur<UploadOutPurchaseData>>();
            ...
            {
                var sapOrderParam = new SapOrderParamOutPur<UploadOutPurchaseData>();
                ...
                {
                    var item = new UploadOutPurchaseData();
