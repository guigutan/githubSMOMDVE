...
namespace SIE.ERPInterface.Sap.Datas.ErpInfoDatas.OtherOut
{
    ...
    [Serializable]
    public class SapOtherOutStorageUploadDataDetail : SapItemParamBase
    {
        /// <summary>
        /// WMS行号
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public class SapOtherOutStorageUploadData<T> : SapOrderParamBase<T>
    {
        /// <summary>
        /// WMS单号
        /// </summary>
