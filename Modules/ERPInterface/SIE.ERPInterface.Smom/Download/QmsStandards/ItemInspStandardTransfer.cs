...
namespace SIE.ERPInterface.Smom.Download.QmsStandards
{
    ...
    /// 物料检验标准校验
    /// </summary>
    public class ItemInspStandardTransfer : InspStandardTransferBase
    {
        /// <summary>
        /// 产品信息"产品编码"-"产品ID"
        /// </summary>
        protected Dictionary<string, double> dicItemCode;
        ...
        //        {
        //            ItemInspectionStandardDetail detail = GenerateDetail(stdData, std, dtlData);
        ...
        /// <returns></returns>
        //private ItemInspectionStandardDetail GenerateDetail(ItemInspStandardData stdData, ItemInspectionStandard std, InspStandardDataDetailBase dtlData)
        //{
        //    var detail = new ItemInspectionStandardDetail()
        //    {
        //        Name = dtlData.Name,
        ...
        public override void ValidData(InspStandardDataBase p)
        {
            ...
            ValidItem(p as ItemInspStandardData);
            base.ValidData(p);
        }
        ...
        private void ValidItem(ItemInspStandardData p)
        {
            if (p.ItemCode.IsNullOrEmpty())
                throw new ValidationException("物料不能为空。".L10N());
            //BussinessDataValid.ValidItem(ref dicItemCode, p.ItemCode, out string messageTip);
            //if (messageTip.IsNotEmpty()) throw new ValidationException("物料".L10N() + messageTip);
        }
    }
}
