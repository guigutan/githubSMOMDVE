SIE.defineCommand('SIE.Web.Inventory.Transactions.Commands.FunctionEmployeeLookupCommand', {
        ...
        if (selections != null && selections.length > 0) {
            ...
            SIE.each(selections, function (item) {
                ...
                if (me._sourceViewSelectItems.indexOf(employeeId) === -1) {
                    var warehouseEmployee = { FunctionId: me._sourceId, EmployeeId: employeeId };
