...
namespace SIE.Wpf.Items.Items
{
    ...
    public class ItemSmallCategoryViewConfig : WPFViewConfig<ItemSmallCategory>
    {
        /// <summary>
        /// 添加工序BOM列表视图
        /// </summary>
        public const string AddProcessBomView = "AddProcessBomView";
        ...
        protected override void ConfigSelectionView()
        {
            ...
            View.Property(LevelNameProperty).HasLabel("分类层级");
            View.Property(ParentsProperty).HasLabel("父级关系");
