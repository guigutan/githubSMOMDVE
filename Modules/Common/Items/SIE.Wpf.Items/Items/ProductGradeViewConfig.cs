...
namespace SIE.Wpf.Items.Items
{
	...
	/// 产品等级视图配置
	/// </summary>
	internal class ProductGradeViewConfig : WPFViewConfig<ProductGrade>
    {
        /// <summary>
        /// 物料维护产品等级ViewGroup
        /// </summary>
        ...
        {
            ////View.HasDelegate(ProductGrade.NameProperty);
        ...
        protected void ItemProductGradeTabView()
        {
            ...
            View.UseDefaultBehaviors();
            View.ClearCommands();
            View.UseCommands(typeof(ProductGradeLookupCommand), typeof(ProductGradeDeleteCommand));
            View.Property(p => p.Code).Show(ShowInWhere.All);
            View.Property(p => p.Name).Show(ShowInWhere.All);
    ...
    /// 物料维护--产品等级页签视图类
    /// </summary>
    internal class ProductGradeExtViewConfig : WPFViewConfig<Item>
    {
        /// <summary>
        /// 物料扩展视图--产品等级视图配置
        /// </summary>
