Ext.define('SIE.Web.Items.Editors.ItemPropertyValueEditor', {
                ...
                var win = SIE.Window.show({
                    ...
                    callback: function (btn) {
                        if (btn == "确定".t()) {
                            ...
                            /** 所有数据的属性定义Id */
                            var totalDefinitionId = [];//取不相同的属性定义
                            /** 选择数据行Id */
                            var selecteds = [];
                            /** 选择数据的属性定义Id */
                            var selDefinitionId = [];
                            ...
                            if (selection.length == 0) {
                                ...
                                if (enableExtendProperty && totalItems.length > 0) {
                                ...
                                for (var i = 0; i < selection.length; i++) {
                                    ...
                                    selecteds.push({
                                        DetailId: selection[i].data.DetailId,
                            ...
                            //var savePropertyValue = Ext.create('SIE.Web.Items.ProductBoms.Commands.PropertyValueSaveCommand');
