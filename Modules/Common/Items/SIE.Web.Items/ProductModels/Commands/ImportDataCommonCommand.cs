...
namespace SIE.Web.Items.ProductModels.Commands
{
    ...
    public abstract class ImportDataCommonCommand : ImportCommandBase
    {
        ...
        protected override object ImportData(ImportViewArgs args, string sheetName = "", bool isFirstRowColumn = true)
        {
            ...
            ImportDataHandleSMOM importDataHandleExt = new ImportDataHandleSMOM(args.SelectedParentId);
    ...
    /// MES导入处理
    /// </summary>
    public class ImportDataHandleSMOM : ImportDataHandleExt
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="parentId"></param>
        public ImportDataHandleSMOM(double parentId) : base(parentId)
        {
        }
