...
namespace SIE.Web.Items.Items
{
    ...
    public class QualityCategoryViewConfig : WebViewConfig<QualityCategory>
    {
        #region 父级节点描述 Parents
        /// <summary>
        /// 父级节点描述
        /// </summary>
        internal static readonly Property<string> ParentsProperty = P<QualityCategory>.RegisterExtensionReadOnly("Parents", typeof(QualityCategoryViewConfig),
        ...
        internal static string GetParents(QualityCategory me)
        {
