Ext.define('SIE.Web.LES.StockOrder.SelectWorkOrderEditor', {
    extend: 'SIE.control.GridComboPopup',
    alias: 'widget.selectworkordereditor',
    setSelValue: function () {
        ...
        if (entity) {
            ...
            entity.setPlanBeginDate(sel.PlanBeginDate);
            entity.setProductName(sel.ProductName);
            entity.setWoQty(sel.PlanQty);
        }
    },
