SIE.defineCommand('SIE.Web.LES.MaterialPreparations.Commands.WorkOrderMpViewExportCommand', {
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    SIE.invokeDataQuery({
                        ...
                        action: 'queryer',
                        type: 'SIE.Web.LES.MaterialPreparations.MaterialWoMpDataqueryer',
                        token: token,
                        logInfo: signdata,
                        success: function (res) {
                            ...
                            me.table2Excel(div, catearr, "工单备料汇总".t() + datestr + ".xls", "Excel");
