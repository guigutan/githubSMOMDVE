Ext.define("SIE.Web.LES.MaterialReturnApplys.Scripts.SelectWorkOrderEditor", {
    extend: 'SIE.control.GridComboPopup',
    alias: 'widget.materialreturnselwoeditor',
    setSelValue: function () {
        ...
        if (entity) {
            ...
            entity.setWipResourceId_Display(sel.WipResource);
            entity.setWipResourceId(sel.WipResourceId);

            entity.setWorkShopId_Display(sel.Workshop);
            entity.setWorkShopId(sel.WorkshopId);

            entity.setProjectId_Display(sel.ProjectCode);
            entity.setProjectId(sel.ProjectId);
