...
namespace SIE.Web.LES.RetreatItemManage.MaterialReturns.Commands
{
    ...
    ///
    /// </summary>
    [JsCommand("SIE.Web.LES.RetreatItemManage.MaterialReturns.Commands.SaveReturnCommand")]
    public class SaveReturnCommand : SaveCommand
    {
        /// <summary>
        /// 保存命令
        /// </summary>
        ...
        protected override void OnSaving(EntityList data)
        {
            ...
            if (lists.Any())
            {
                lists.First().PersistenceStatus = PersistenceStatus.New;
