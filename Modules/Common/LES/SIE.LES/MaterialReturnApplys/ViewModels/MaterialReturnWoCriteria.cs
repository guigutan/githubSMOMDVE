...
namespace SIE.LES.MaterialReturnApplys.ViewModels
{
    ...
    [Label("退料申请工单查询实体")]
    public class MaterialReturnWoCriteria : Criteria
    {
        #region 工单号 WoNo
        /// <summary>
        /// 工单号
        /// </summary>
        [Label("工单号")]
        public static readonly Property<string> WoNoProperty = P<MaterialReturnWoCriteria>.Register(e => e.WoNo);
        ...
        public static readonly IRefIdProperty FactoryIdProperty =
            P<MaterialReturnWoCriteria>.RegisterRefId(e => e.FactoryId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> FactoryProperty =
            P<MaterialReturnWoCriteria>.RegisterRef(e => e.Factory, FactoryIdProperty);
        ...
        public static readonly IRefIdProperty WorkshopIdProperty =
            P<MaterialReturnWoCriteria>.RegisterRefId(e => e.WorkshopId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> WorkshopProperty =
            P<MaterialReturnWoCriteria>.RegisterRef(e => e.Workshop, WorkshopIdProperty);
        ...
        public static readonly IRefIdProperty WipResourceIdProperty =
            P<MaterialReturnWoCriteria>.RegisterRefId(e => e.WipResourceId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<WipResource> WipResourceProperty =
            P<MaterialReturnWoCriteria>.RegisterRef(e => e.WipResource, WipResourceIdProperty);
        ...
        /// </summary>
        [Label("产品编码")]
        public static readonly Property<string> ProductCodeProperty = P<MaterialReturnWoCriteria>.Register(e => e.ProductCode);
        ...
        /// </summary>
        [Label("产品名称")]
        public static readonly Property<string> ProductNameProperty = P<MaterialReturnWoCriteria>.Register(e => e.ProductName);
        ...
        {
            return RT.Service.Resolve<MaterialReturnApplyController>().GetMaterialReturnWoViewModels(this);
        }
    }
}
