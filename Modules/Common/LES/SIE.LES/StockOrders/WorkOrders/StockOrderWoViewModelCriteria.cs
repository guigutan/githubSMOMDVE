...
namespace SIE.LES.StockOrders.WorkOrders
{
    ...
    [Label("备料单工单查询实体")]
    public class StockOrderWoViewModelCriteria : Criteria
    {
        #region 工单号 WoNo
        /// <summary>
        /// 工单号
        /// </summary>
        [Label("工单号")]
        public static readonly Property<string> WoNoProperty = P<StockOrderWoViewModelCriteria>.Register(e => e.WoNo);
        ...
        public static readonly IRefIdProperty FactoryIdProperty =
            P<StockOrderWoViewModelCriteria>.RegisterRefId(e => e.FactoryId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> FactoryProperty =
            P<StockOrderWoViewModelCriteria>.RegisterRef(e => e.Factory, FactoryIdProperty);
        ...
        public static readonly IRefIdProperty WorkshopIdProperty =
            P<StockOrderWoViewModelCriteria>.RegisterRefId(e => e.WorkshopId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> WorkshopProperty =
            P<StockOrderWoViewModelCriteria>.RegisterRef(e => e.Workshop, WorkshopIdProperty);
        ...
        public static readonly IRefIdProperty WipResourceIdProperty =
            P<StockOrderWoViewModelCriteria>.RegisterRefId(e => e.WipResourceId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<WipResource> WipResourceProperty =
            P<StockOrderWoViewModelCriteria>.RegisterRef(e => e.WipResource, WipResourceIdProperty);
        ...
        /// </summary>
        [Label("产品编码")]
        public static readonly Property<string> ProductCodeProperty = P<StockOrderWoViewModelCriteria>.Register(e => e.ProductCode);
        ...
        /// </summary>
        [Label("产品名称")]
        public static readonly Property<string> ProductNameProperty = P<StockOrderWoViewModelCriteria>.Register(e => e.ProductName);
        ...
        {
            return RT.Service.Resolve<StockOrderService>().GetStockOrderWoViewModels(this);
        }
    }
}
