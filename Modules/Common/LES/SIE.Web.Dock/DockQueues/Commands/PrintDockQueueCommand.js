SIE.defineCommand('SIE.Web.Dock.DockQueues.Commands.PrintDockQueueCommand', {
    ...
    execute: function (view, source) {
        ...
        SIE.invokeDataQuery({
            ...
            method: 'GetDockQueueDefaultTemplate',
            token: view.token,
            params: [],
    ...
    showWin: function (view, entityData, billIds) {
        var me = this;
        SIE.AutoUI.getMeta({
            model: 'SIE.Dock.ViewModels.DockQueuePrintViewModel',
            ignoreCommands: true,
            isDetail: true,
            ignoreQuery: false,
