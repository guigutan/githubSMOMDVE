SIE.defineCommand('SIE.Web.Dock.DockQueues.Commands.CancelDockQueueCommand', {
    meta: { text: "取消", group: "edit", iconCls: "iconfont icon-Cancel icon-blue" },
    canExecute: function (view) {
        ...
        var dt = new Date();
        if (sel.any(function (p) { return p.getQueueState() != 0 && p.getQueueState() != 1; }))
            return false;
