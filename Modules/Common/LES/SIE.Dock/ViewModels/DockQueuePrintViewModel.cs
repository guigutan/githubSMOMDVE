...
namespace SIE.Dock.ViewModels
{
    ...
    [Label("月台排队打印")]
    public class DockQueuePrintViewModel : ViewModel
    {
        ...
        public static readonly IRefIdProperty PrintTemplateIdProperty =
            P<DockQueuePrintViewModel>.RegisterRefId(e => e.PrintTemplateId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<PrintTemplate> PrintTemplateProperty =
            P<DockQueuePrintViewModel>.RegisterRef(e => e.PrintTemplate, PrintTemplateIdProperty);
