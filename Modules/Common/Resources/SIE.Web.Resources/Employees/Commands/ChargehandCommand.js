SIE.defineCommand('SIE.Web.Resources.Employees.Commands.ChargehandCommand', {
    meta: { text: "设为组长", group: "edit", iconCls: "icon-PeopleSetting icon-blue" },
    ...
    execute: function (view, source) {
        ...
        if (entityList.length > 0) {
            ...
            var msg = Ext.String.format('确定设为组长吗？'.t());
