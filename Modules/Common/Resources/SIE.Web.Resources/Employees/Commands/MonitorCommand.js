SIE.defineCommand('SIE.Web.Resources.Employees.Commands.MonitorCommand', {
    meta: { text: "设为班长", group: "edit", iconCls: "icon-PeopleSetting icon-blue" },
    ...
    execute: function (view, source) {
        ...
        if (entityList.length > 0) {
            ...
            var msg = Ext.String.format('确定设为班长吗？'.t());
