SIE.defineCommand('SIE.Web.Resources.Employees.Commands.EmployeeResourceDLTemplateCommand', {
    ...
    */
    createExportParam: function (view) {
        var me = this;
        var param = {
            Name: "SIE.Web.Resources.Employees.Commands.EmployeeResourceImportCommand",
            Token: view.getToken(),
