SIE.defineCommand('SIE.Web.Resources.Employees.Commands.EmployeeLabelPrintCommand', {
    meta: { text: "人员条码化打印", group: "edit", iconCls: "icon-PrintData icon-blue" },
    ...
    execute: function (view, source) {
        ...
        SIE.AutoUI.getMeta({
            model: "SIE.Web.Resources.Employees.ViewModels.EmployeeViewModels",
                                    ...
                                    if (rstPrint.ErrMsg !== '') {
                                        ...
                                        if (cfg && cfg.printCallback) {
                                            ...
                                            if (!printCmpt.hasError()) {
                                                ...
                                                if (!printCmpt.hasError())
                                                    CRT.Workbench.showPageDialog({ id: 'ReprintBatch_rpt', text: "人员条码化打印".t(), method: 'POST', url: printUrl, params: param });
                                            }
                                        }
