...
namespace SIE.Wpf.Resources.Editors
{
    ...
    /// 企业模型编辑器
    /// </summary>
    public class EnterpriseEditor : PagingLookUpEditor
    {
        /// <summary>
        /// 编辑器名称
        /// </summary>
        public const string EditorName = "EnterpriseEditor";
        ...
        {
            return RT.Service.Resolve<EnterpriseController>().GetEnterprises(null, pagingInfo, keyword);
        }
    }
}