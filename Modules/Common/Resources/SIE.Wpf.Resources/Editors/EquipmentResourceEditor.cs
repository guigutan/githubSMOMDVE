...
namespace SIE.Wpf.Resources.Editors
{
    ...
    /// 设备资源编辑器
    /// </summary>
    public class EquipmentResourceEditor : PagingLookUpEditor
    {
        /// <summary>
        /// 编辑器名称
        /// </summary>
        public const string EditorName = "EquipmentResourceEditor";
        ...
        protected override EntityList GetDataSourceCore(Entity source, PagingInfo pagingInfo, string keyword, IManagedProperty titleProperty)
        {
            ...
            return RT.Service.Resolve<WipResourceController>().GetWipResources(stateList, new List<SyncSourceType>() { SyncSourceType.Equipment }, pagingInfo, keyword);
        }
    }
}