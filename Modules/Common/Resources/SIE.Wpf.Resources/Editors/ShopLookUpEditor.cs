...
namespace SIE.Wpf.Resources.Editors
{
    ...
    /// 资源车间下拉编辑器
    /// </summary>
    public class ShopLookUpEditor : PagingLookUpEditor
    {
        /// <summary>
        /// 编辑器名称
        /// </summary>
        public const string EditorName = "ShopLookUpEditor";
        ...
        {
            return RT.Service.Resolve<EnterpriseController>().GetEnterprises(EnterpriseType.Shop, pagingInfo, keyword);
        }
    }
}
