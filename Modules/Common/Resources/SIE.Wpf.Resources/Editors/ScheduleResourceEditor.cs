...
namespace SIE.Wpf.Resources.Editors
{
    ...
    /// 生产资源编辑器
    /// </summary>
    public class WipResourceEditor : PagingLookUpEditor
    {
        /// <summary>
        /// 编辑器名称
        /// </summary>
        public const string EditorName = "WipResourceEditor";
        ...
        protected override EntityList GetDataSourceCore(Entity source, PagingInfo pagingInfo, string keyword, IManagedProperty titleProperty)
        {
            ...
            return RT.Service.Resolve<WipResourceController>().GetWipResources(stateList, null, pagingInfo, keyword);
        }
    }
}