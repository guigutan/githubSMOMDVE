...
namespace SIE.Resources.ProcessTechs.Configs
{
    ...
    [Label("制程工艺编码生成规则")]
    public class ProcessTechNoConfigValue : ConfigValue
    {
        ...
        public static readonly IRefIdProperty NumberRuleIdProperty =
            P<ProcessTechNoConfigValue>.RegisterRefId(e => e.NumberRuleId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<NumberRule> NumberRuleProperty =
            P<ProcessTechNoConfigValue>.RegisterRef(e => e.NumberRule, NumberRuleIdProperty);
