...
using SIE.Tech.Stations.ImportStationProcess;
...
namespace SIE.Web.Tech.Stations.Commands
{
    ...
    /// 工位工序导入命令
    /// </summary>
    public class StationProcessImportCommand : ImportCommandBase
    {
        /// <summary>
        /// 导入完成回调方法
        /// </summary>
        ...
        /// 获取导入处理类型
        /// </summary>
        /// <returns>工位工序导入处理类</returns>
        protected override Type GetImportHandleType()
        {
            return typeof(ImportStationProcessWebHandle);
        }
    }
}
