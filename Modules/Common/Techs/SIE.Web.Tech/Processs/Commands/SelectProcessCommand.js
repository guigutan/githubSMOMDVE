/**
  ...
  * 
*/
SIE.defineCommand('SIE.Web.Tech.Processs.Commands.SelectProcessCommand', {
        ...
        if (selections && selections.length > 0) {
            ...
            SIE.each(selections, function (item) {
                ...
                if (me._sourceViewSelectItems.indexOf(processId) === -1) {
                    var processEmployee = { EmployeeId: me._sourceId, ProcessId: processId };
                    operationDatas.push(processEmployee);
                }
            });
