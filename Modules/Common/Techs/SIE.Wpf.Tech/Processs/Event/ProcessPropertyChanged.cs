...
namespace SIE.Wpf.Tech.Processs.Event
{
    /// <summary>
    /// 工序属性变更事件
    /// </summary>
    public class ProcessPropertyChanged
    {
        ...
        public void SaveProcess_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
        ...
        public void SaveProcessTypePropertyChanged(Process process)
        {
        ...
        ProcessParameter CreateProcessParameter(ResultTypeForDesign resultTypeForDesign)
        {
            return new ProcessParameter()
            {
                ...
                Description = resultTypeForDesign == ResultTypeForDesign.Custom ? string.Empty : EnumViewModel.EnumToLabel(resultTypeForDesign),
            };
        }
    }
}