...
{
    /// <summary>
    /// 活动接口转Visibility枚举值转换器
    /// </summary>
    class IActivityToVisibilityConverterExtension : MarkupExtension, IValueConverter
    {
        /// <summary>
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (activity == null || !activity.IsSelected || activity.Type == ActivityType.Completion)
                return Visibility.Collapsed;
            if (activity.Rules.Count > 0)
