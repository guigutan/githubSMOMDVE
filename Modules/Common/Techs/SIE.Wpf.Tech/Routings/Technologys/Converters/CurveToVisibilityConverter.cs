...
{
    /// <summary>
    /// 规则类型枚举转Visibility枚举值转换器
    /// </summary>
    public class CurveToVisibilityConverterExtension : MarkupExtension, IValueConverter
    {
        /// <summary>
        ...
        {
            if ((RuleType)value == RuleType.Curve)
