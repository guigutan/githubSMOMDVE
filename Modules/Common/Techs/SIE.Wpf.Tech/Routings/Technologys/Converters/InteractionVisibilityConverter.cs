...
{
    /// <summary>
    /// 活动类型枚举字符串转Visibility枚举值转换器
    /// </summary>
    public class InteractionVisibilityConverterExtension : MarkupExtension, IValueConverter
    {
        /// <summary>
        ...
        /// 转换值
        /// </summary>
        /// <param name="value">活动类型枚举字符串转</param>
        ...
        {
            if (value.ToString() == ActivityType.Interaction.ToString())
