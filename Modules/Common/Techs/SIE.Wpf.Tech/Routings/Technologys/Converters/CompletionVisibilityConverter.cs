...
{
    /// <summary>
    /// 活动类型枚举转Visibility枚举值转换器
    /// </summary>
    public class CompletionVisibilityConverterExtension : MarkupExtension, IValueConverter
    {
        /// <summary>
        ...
        {
            if (value.ToString() == ActivityType.Completion.ToString())
