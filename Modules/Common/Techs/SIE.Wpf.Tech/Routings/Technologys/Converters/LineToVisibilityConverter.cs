...
{
    /// <summary>
    /// 规则类型转换Visibility枚举转换器
    /// </summary>
    public class LineToVisibilityConverterExtension : MarkupExtension, IValueConverter
    {
        /// <summary>
        ...
        /// 转换值
        /// </summary>
        /// <param name="value">RuleType枚举</param>
        ...
        {
            if ((RuleType)value == RuleType.Line)
