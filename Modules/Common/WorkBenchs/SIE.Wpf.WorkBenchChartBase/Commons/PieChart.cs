...
namespace SIE.Wpf.WorkBenchChartBase.Commons
{
    ...
    /// 饼状图
    /// </summary>
    //[ChartDefinitionAttribute("E:\\壁纸\\guanlan_gaoshou-007.jpg", "SimpleDiagramChart", PieChart._title)]
    public class PieChart : UserControl, IChart
    {
        private const string _title = "饼状图";
        ...
        /// 图表
        /// </summary>
        protected SimpleDiagram2D _diagram;
        ...
        {
            return new List<Series> { new PieSeries2D() };
        }
        ...
        {
            return new TestChartViewModel { Title = _title.L10N(), ChartAlertLevel = SIE.WorkBenchChartBase.Commons.ChartAlertLevel.Yellow };
        }
        ...
        {
            const string defpath = "pack://application:,,,/SIE.Wpf.WorkBenchChartBase;component/ChartControls/SimpleDiagram.xaml";
            ...
            _diagram = _control.Diagram as SimpleDiagram2D;
        }
