SIE.defineCommand('SIE.Web.Core.Common.Commands.Import.ImportMasterSubordinateDynamicCommand', {
    extend: 'SIE.Web.Common.Import.Commands.ImportCommandBase',
    meta: { text: "导入", group: "business", iconCls: "icon-Download icon-blue", model: "" },
   ...
   */
     ...
     * @param {any} myview
     */
    getParent: function (myview) {
        return myview.getParent() != null && myview.getParent().getCurrent() != null ? myview.getParent().getCurrent().data : null;
    },
                ...
                listeners: {
                    change: function (field, newValue) {
                        ...
                        fileReader.onload = function (e) {
                            ...
                            var parent = me.getParent(myview);
                            myview.execute({
                                data: {
        ...
        var grid = Ext.create("Ext.grid.Panel", {
            ...
            tbar: [{
                ...
                handler: function () {
                    ...
                    var tittle = myview.label + Ext.util.Format.date(new Date(), 'Ymdhis')
                    grid.saveDocumentAs({
                        type: 'xlsx',
                        title: '导入失败的数据',
                        fileName: tittle + '.xlsx'
                    });
