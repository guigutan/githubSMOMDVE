...
namespace SIE.Web.Core.QmsStaticConst
{
	...
	/// K2视图配置
	/// </summary>
	internal class StaticConstK2ViewConfig : WebViewConfig<StaticConstK2>
	{
		...
		protected override void ConfigListView()
		{
			...
			View.AddBehavior("SIE.Web.Core.QmsStaticConst.Behaviors.StaticConstK2Behavior");
			View.WithoutPaging();
			View.InlineEdit();
			View.ClearCommands();
			View.UseCommands(WebCommandNames.Add, "SIE.Web.Core.QmsStaticConst.Commands.K2.DeleteCommand");
			View.Property(p => p.EvaluateQty).UseSpinEditor(c => { c.MinValue = 4; c.AllowNegative = false; c.AllowDecimals = false; }).DisableSort();
