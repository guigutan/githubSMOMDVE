...
namespace SIE.Web.Core.QmsStaticConst
{
	...
	/// K3视图配置
	/// </summary>
	internal class StaticConstK3ViewConfig : WebViewConfig<StaticConstK3>
	{
		...
		protected override void ConfigListView()
		{
			...
			View.AddBehavior("SIE.Web.Core.QmsStaticConst.Behaviors.StaticConstK3Behavior");
			View.WithoutPaging();
			View.InlineEdit();
			View.ClearCommands();
			View.UseCommands(WebCommandNames.Add, "SIE.Web.Core.QmsStaticConst.Commands.K3.DeleteCommand");
			View.Property(p => p.SampleQty).UseSpinEditor(c => { c.MinValue = 11; c.AllowNegative = false; c.AllowDecimals = false; }).DisableSort();
