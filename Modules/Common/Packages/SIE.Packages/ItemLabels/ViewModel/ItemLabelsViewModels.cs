...
namespace SIE.Web.Packages.ItemLabels.ViewModels
{
    /// <summary>
    /// 物料标签打印 ViewModel
    /// </summary> 
    ...
    [Label("物料标签打印")]
    public class ItemLabelsViewModels : ViewModel
    {
        ...
        public static readonly IRefIdProperty TemplateIdProperty =
            P<ItemLabelsViewModels>.RegisterRefId(e => e.TemplateId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<PrintTemplate> TemplateProperty =
            P<ItemLabelsViewModels>.RegisterRef(e => e.Template, TemplateIdProperty);
    ...
    /// 物料批次打印 视图
    /// </summary>
    internal class ItemLabelsViewModelConfig : WebViewConfig<ItemLabelsViewModels>
    {
        /// <summary>
        /// 配置明细视图
        /// </summary>
        ...
        {
            View.AssignAuthorize(typeof(SIE.Packages.ItemLabels.ItemLabel));
            View.Property(p => p.Template).UseDataSource((source, pagingInfo, keyword) =>
            {
                var model = source as ItemLabelsViewModels;
                Check.NotNull(model, nameof(ItemLabelsViewModels));
                ...
                var qualifiedName = typeof(ItemLabelPrintable).GetQualifiedName();
