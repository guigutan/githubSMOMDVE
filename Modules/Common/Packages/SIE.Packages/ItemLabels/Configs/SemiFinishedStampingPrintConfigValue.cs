...
namespace SIE.Packages.ItemLabels.Configs
{
    ...
    public class SemiFinishedStampingPrintConfigValue : ConfigValue
    {
        /// <summary>
        /// id
        /// </summary>
        public static readonly IRefIdProperty BarcodeRuleIdProperty =
            P<SemiFinishedStampingPrintConfigValue>.RegisterRefId(e => e.BarcodeRuleId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<NumberRule> BarcodeRuleProperty =
            P<SemiFinishedStampingPrintConfigValue>.RegisterRef(e => e.BarcodeRule, BarcodeRuleIdProperty);
    ...
    /// 原材料条码规则和模板配置值配置
    /// </summary>
    class SemiFinishedStampingPrintConfigValueConfig : EntityConfig<SemiFinishedStampingPrintConfigValue>
    {
        /////// <summary>
        /////// 验证
        /////// </summary>
