SIE.defineCommand('SIE.Web.Packages.ItemLabels.Commands.ItemLabelExportCommand', {
                ...
                handler: function () {
                    ...
                    SIE.invokeDataQuery({
                        ...
                        success: function (res) {
                            ...
                            me.table2Excel(div, catearr, "物料标签表".t() + datestr + ".xls", "Excel");
