SIE.defineCommand('SIE.Web.Packages.ItemLabels.Commands.ItemLabelLabelPrintCommand', {
    meta: { text: "物料标签打印", group: "edit", iconCls: "icon-PrintData icon-blue" },
    ...
    execute: function (view, source) {
        ...
        SIE.AutoUI.getMeta({
            model: "SIE.Web.Packages.ItemLabels.ViewModels.ItemLabelsViewModels",
            ...
            callback: function (res) {
                ...
                SIE.invokeDataQuery({
                    type: "SIE.Web.Packages.ItemLabels.DataQuerys.ItemLabelDataQuery",
                            ...
                            var win = SIE.Window.show({
                                ...
                                callback: function (btn) {
                                    if (btn == "确定".t()) {
                                        ...
                                        view.execute({
                                            data: { HuIds: view.getSelectionIds(), TemplateId: reprintInfo.TemplateId },
