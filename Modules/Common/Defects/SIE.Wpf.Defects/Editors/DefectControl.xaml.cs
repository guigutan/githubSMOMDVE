...
namespace SIE.Wpf.Defects.Editors
{
    ...
    public partial class DefectControl : UserControl
    {
        ...
        public static readonly DependencyProperty SelectedValueProperty =
            DependencyProperty.Register("SelectedValue", typeof(ObservableCollection<DefectItem>), typeof(DefectControl), new PropertyMetadata(new ObservableCollection<DefectItem>(), (s, e) => { ((DefectControl)s).OnValueChanged(e); }));
        ...
        public static readonly DependencyProperty DefectsProperty =
            DependencyProperty.Register("Defects", typeof(EntityList<Defect>), typeof(DefectControl), new PropertyMetadata(new EntityList<Defect>(), (s, e) => { ((DefectControl)s).OnDefectsChanged(e); }));
    ...
    public class DefectItem : ObservableObject
    {
        ...
        /// Control
        /// </summary>
        public DefectControl Control { get; set; }
