SIE.defineCommand('SIE.Web.Warehouses.Commands.StorageLocationEnableCommand', {
    ...
    canExecute: function (view) {
        ...
        if (storageLocationlist == null || storageLocationlist.length == 0) {
            ...
            if (storageLocation == null || view.getData().isDirty() || storageLocation.data.State != 0 || storageLocation.data.AreaState != 1) {
                return false;
            }
        } else {
            ...
            for (var i = 0; i < storageLocationlist.length; i++) {
                if ( storageLocationlist[i].data.AreaState == 0 || storageLocationlist[i].data.State == 1)
                    return false;
            }
        }
        return true;
