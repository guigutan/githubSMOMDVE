...
namespace SIE.Web.SO.SaleOrders.ViewModels
{
    ...
    /// </summary>
    [RootEntity]
    public class ImportSaleOrderCheckViewModel : ViewModel
    {
        ...
        /// </summary>
        [Label("导入文件")]
        public static readonly Property<string> ImportFilePathProperty = P<ImportSaleOrderCheckViewModel>.Register(e => e.ImportFilePath);
        ...
        /// </summary>
        [Label("导入成功数量")]
        public static readonly Property<int> ImportSuccessAmountProperty = P<ImportSaleOrderCheckViewModel>.Register(e => e.ImportSuccessAmount);
        ...
        /// </summary>
        [Label("导入失败数量")]
        public static readonly Property<int> ImportFailAmountProperty = P<ImportSaleOrderCheckViewModel>.Register(e => e.ImportFailAmount);
        ...
        /// </summary>
        [Label("导入处理消息")]
        public static readonly Property<string> ImportProcessMsgProperty = P<ImportSaleOrderCheckViewModel>.Register(e => e.ImportProcessMsg);
    ...
    /// 销售订单导入 视图配置
    /// </summary>
    class ImportSaleOrderCheckViewModelConfig : WebViewConfig<ImportSaleOrderCheckViewModel>
    {
        /// <summary>
        /// 配置默认试图
        /// </summary>
