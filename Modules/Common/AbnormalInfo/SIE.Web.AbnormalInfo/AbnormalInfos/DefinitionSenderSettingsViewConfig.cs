...
namespace SIE.Web.AbnormalInfo.AbnormalInfoss
{
    ...
    public class DefinitionSenderSettingsViewConfig : WebViewConfig<DefinitionSenderSettings>
    {
        #region 接收人 ReceiverValue
        /// <summary>
        /// 接收人
        /// </summary>
        public static readonly Property<string> ReceiverValueProperty = P<DefinitionSenderSettings>.RegisterExtensionReadOnly("ReceiverValue", typeof(DefinitionSenderSettingsViewConfig),
            GetReceiverValue, DefinitionSenderSettings.PusherProperty);
        ...
        {
            var current = me as DefinitionSenderSettings;
