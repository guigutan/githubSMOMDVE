...
namespace SIE.AbnormalMonitor.AbnormalMonitors.Pushers
{
    ...
    /// </summary>
    [Serializable]
    [Sender("异常处理推送插件", typeof(AbnormalMonitorEmailSenderConfig), SenderType.Email)]
    public class AbnormalMonitorEmailSender : EmailSender
    {
        /// <summary>
        /// 创建发送参数对象
        /// </summary>
        ...
        {
            AbnormalMonitorAlertResult alertResult = result as AbnormalMonitorAlertResult;
