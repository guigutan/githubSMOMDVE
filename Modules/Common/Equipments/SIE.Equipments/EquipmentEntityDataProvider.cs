...
////指定此程序集中实体的默认仓库
[assembly: Repository(typeof(EquipmentEntityRepository<>))]
namespace SIE.Equipments
{
    ...
    public class EquipmentEntityRepository<T> : EntityRepository<T>
        where T : Entity
    {
    ...
    /// 数据提供者
    /// </summary>
    public class EquipmentEntityDataProvider : RdbDataProvider
    {
        /// <summary>
        /// 数据库连接字符串的名称
        /// </summary>
