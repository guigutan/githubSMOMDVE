...
namespace SIE.Equipments.Configs
{
    ...
    public class EquipModelBomCodeConfig : ModuleConfig<EquipModelBomCodeConfigValue>
    {
        /// <summary>
        /// 默认值
        /// </summary>
        readonly EquipModelBomCodeConfigValue defaultValue = new EquipModelBomCodeConfigValue { NumberRule = null };

        /// <summary>
        /// 默认值
        /// </summary>
        public override EquipModelBomCodeConfigValue DefaultValue
        {
            get
            {
                return defaultValue;
    ...
    [Label("设备型号BOM编码")]
    public class EquipModelBomCodeConfigValue : ConfigValue
    {
        ...
        public static readonly IRefIdProperty NumberRuleIdProperty =
              P<EquipModelBomCodeConfigValue>.RegisterRefId(e => e.NumberRuleId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<NumberRule> NumberRuleProperty =
            P<EquipModelBomCodeConfigValue>.RegisterRef(e => e.NumberRule, NumberRuleIdProperty);
