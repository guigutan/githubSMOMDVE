Ext.define('SIE.Web.Fixtures.Accounts.AddIDAccountBehavior', {
    /**
     * view生命周期函数--view准备完成
    ...
    _onEntityPropertyChanged: function (e) {
        ...
        if (e.property === "FixtureEncodeId") {
            var data = e.entity;
            e.entity.setFixtureWarehouseId(null);
            e.entity.setFixtureWarehouseName("");
            e.entity.setFixtureWarehouseId_Display("");
            e.entity.setFixtureStorageLocationId(null);
            e.entity.setFixtureStorageLocationName("");
            e.entity.setFixtureStorageLocationId_Display("");
