...
namespace SIE.Web.Equipments.EquipAccounts.Commands
{
    ...
    /// 设备台账导入功能
    /// </summary>
    [JsCommand("SIE.Web.Equipments.EquipAccounts.Commands.EquipAccountImportCommand")]
    public class EquipAccountImportCommand : ImportCommandBase
    {
        ...
        {
            const string templateFileName = "设备台账导入模板.xlsx";
        ...
        {
            return typeof(ImportEquipAccountHandle);
        }
    }
}
