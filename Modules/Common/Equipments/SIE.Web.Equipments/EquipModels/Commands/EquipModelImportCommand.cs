...
namespace SIE.Web.Equipments.EquipModels.Commands
{
    ...
    /// 设备型号导入功能
    /// </summary>
    [JsCommand("SIE.Web.Equipments.EquipModels.Commands.EquipModelImportCommand")]
    public class EquipModelImportCommand : ImportCommandBase
    {
        ...
        {
            const string templateFileName = "设备型号导入模板.xlsx";
        ...
        {
            return typeof(ImportEquipModelHandle);
        }
    }
}
