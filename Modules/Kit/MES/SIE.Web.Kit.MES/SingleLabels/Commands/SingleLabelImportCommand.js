SIE.defineCommand('SIE.Web.Kit.Mes.SingleLabelImportCommand', {
    extend: 'SIE.Web.Common.Import.Commands.ImportCommand',
    meta: { text: "数据导入", group: "business", iconCls: "icon-Download icon-blue", model: "SIE.Web.Kit.Mes.SingleLabels.ImportSingleLabelDetailModel" },
