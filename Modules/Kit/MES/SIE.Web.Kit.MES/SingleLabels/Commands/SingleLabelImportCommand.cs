...
using SIE.Packages.SingleLables;
...
namespace SIE.Web.Kit.Mes
{
    ...
    /// 单体条码导入
    /// </summary>
    [JsCommand("SIE.Web.Kit.Mes.SingleLabelImportCommand")]
    public class SingleLabelImportCommand : ImportCommandBase
    {
        /// <summary>
        /// 执行
        /// </summary>
        ...
        {
            return typeof(ImportSingleLabelHandle);
        }
        ...
        protected override object Excute(ImportViewArgs importViewArgs, string scope)
        {
            ...
            if (behaviorName == "DownloadCustom")
            {
                //自定义下载模板方法
        ...
        protected override object ImportData(ImportViewArgs args, string sheetName = "", bool isFirstRowColumn = true)
        {
            ...
            ImportDataHandleSingleLabel importDataHandleExt = new ImportDataHandleSingleLabel(args.SelectedParentId);
        ...
        {
            string templateFileName = "单体条码导入模板.xls";
    ...
    /// QMS导入处理
    /// </summary>
    public class ImportDataHandleSingleLabel : ImportDataHandleExt
    {
        /// <summary>
        /// 导入处理
        /// </summary>
        /// <param name="parentId">父ID</param>
        public ImportDataHandleSingleLabel(double parentId) : base(parentId)
        {
        }
        ...
        /// <param name="columnList">列表</param>
