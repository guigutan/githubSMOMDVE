...
namespace SIE.Web.EMS.Purchases.PaymentPlans.Commands
{
    ...
    /// 审核采购
    /// </summary>
    [JsCommand("SIE.Web.EMS.Purchases.PaymentPlans.Commands.ExaminePaymentPlanCommand")]
    public class ExaminePaymentPlanCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<PaymentPlanController>().ExaminePaymentPlan(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
