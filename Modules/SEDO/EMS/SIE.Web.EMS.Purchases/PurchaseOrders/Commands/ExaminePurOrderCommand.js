SIE.defineCommand('SIE.Web.EMS.Purchases.PurchaseOrders.Commands.ExaminePurOrderCommand', {
    ...
    execute: function (view, source) {
        var win = SIE.Window.show({
            ...
            items: {
                ...
                items: [{
                    xtype: 'combobox',
                    id: 'ExaminePurOrder_Result',
                    name: 'ExaminePurOrderResult',
                    margin: '5',
                    fieldLabel: '审核结果'.t(),
                    editable: false,
                    queryMode: 'local',
            ...
            id: "ExaminePurOrderCommand001",
            callback: function (btn) {
                if (btn == "确定".t()) {
                    var selectModels = view.getSelection();
                    var selectIds = view.getSelectionIds(selectModels);
                    var result = Ext.getCmp('ExaminePurOrder_Result');
