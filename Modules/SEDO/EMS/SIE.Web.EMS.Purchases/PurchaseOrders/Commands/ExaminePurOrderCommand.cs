...
namespace SIE.Web.EMS.Purchases.PurchaseOrders.Commands
{
    ...
    /// 审核采购
    /// </summary>
    [JsCommand("SIE.Web.EMS.Purchases.PurchaseOrders.Commands.ExaminePurOrderCommand")]
    public class ExaminePurOrderCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<PurchaseOrderController>().ExaminePurOrder(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
