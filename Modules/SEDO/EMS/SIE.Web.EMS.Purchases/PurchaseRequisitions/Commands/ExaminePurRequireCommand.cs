...
namespace SIE.Web.EMS.Purchases.PurchaseRequisitions.Commands
{
    ...
    /// 审核采购
    /// </summary>
    [JsCommand("SIE.Web.EMS.Purchases.PurchaseRequisitions.Commands.ExaminePurRequireCommand")]
    public class ExaminePurRequireCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<PurchaseRequisitionController>().ExaminePurRequire(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
