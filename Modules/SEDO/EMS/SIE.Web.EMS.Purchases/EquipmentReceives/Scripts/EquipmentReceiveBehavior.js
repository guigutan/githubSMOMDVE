Ext.define('SIE.Web.EMS.Purchases.EquipmentReceives.EquipmentReceiveBehavior', {
    /**
     * view生命周期函数--view聚合后
     * @param {*} view 生成的view
     */
                ...
                SIE.invokeDataQuery({
                    ...
                    success: function (res) {
                        if (res.Result) {
                            ...
                            entity.setAcceptanceType(info.AcceptanceType);
                        }
                    }
                });
            }
    ...
    onEntityPropertyChanged: function (e) {
        ...
        if (e.property === 'FactoryId' || e.property === 'DepartmentId' || e.property === 'ReceiveType') {
            let childView = me._children.first(function (p) { return p.model === "SIE.EMS.Purchases.EquipmentReceives.EquipmentReceiveDetail"; });
            if (childView) {
                ...
                SIE.each(store, function (entity) {
                    ...
                    entity.setOrderEquipModelId(null);
                });
