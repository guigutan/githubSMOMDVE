...
namespace SIE.Web.EMS.Purchases.SparePartReceives
{
    ...
    /// 批次明细视图配置
    /// </summary>
    public class SparePartReceiveLotViewConfig : WebViewConfig<SparePartReceiveLot>
    {
        /// <summary>
        /// 扫描视图
        /// </summary>
        ...
        protected override void ConfigListView()
        {
            ...
            View.UseCommands("SIE.Web.EMS.Purchases.SparePartReceives.Commands.LotScreenCommand", "SIE.Web.EMS.Purchases.SparePartReceives.Commands.LotPrintCommand");
            ...
            View.Property(p => p.LotNo).ShowInList(150);
        ...
        protected void ConfigScanView()
        {
            ...
            View.UseCommand(typeof(DeleteReceiveLotCommand).FullName);
            using (View.OrderProperties())
            {
                ...
                View.Property(p => p.SupplierName).ShowInList(150);
                View.Property(p => p.PurchaseObjectType).ShowInList();
