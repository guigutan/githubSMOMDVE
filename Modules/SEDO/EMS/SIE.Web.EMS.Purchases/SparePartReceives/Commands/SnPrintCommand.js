SIE.defineCommand('SIE.Web.EMS.Purchases.SparePartReceives.Commands.SnPrintCommand', {
                ...
                if (rstPrint.ErrMsg !== '') {
                    ...
                    if (cfg && cfg.printCallback) {
                        ...
                        if (!printCmpt.hasError()) {
                            ...
                            if (!printCmpt.hasError())
                                CRT.Workbench.showPageDialog({ id: 'SparePartReceiveSnPrint_rpt', text: "打印".t(), method: 'POST', url: printUrl, params: param });
                        }
                    }
                    view.reloadData();
                }
