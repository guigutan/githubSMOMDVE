...
namespace SIE.Web.EMS.Purchases.EquipmentAcceptances.Commands
{
    ...
    /// 审核设备验收
    /// </summary>
    [JsCommand("SIE.Web.EMS.Purchases.EquipmentAcceptances.Commands.ExamineEquipAcceptCommand")]
    public class ExamineEquipAcceptCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<EquipmentAcceptanceController>().ExamineEquipAccept(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
