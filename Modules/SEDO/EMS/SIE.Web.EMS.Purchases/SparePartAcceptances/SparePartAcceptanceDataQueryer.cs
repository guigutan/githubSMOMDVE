...
namespace SIE.Web.EMS.Purchases.SparePartAcceptances
{
    ...
    /// 备件验收查询器
    /// </summary>
    public class SparePartAcceptanceDataQueryer : DataQueryer
    {
        /// <summary>
        /// 保存备件验收附件
        /// </summary>
        ...
        /// <returns>路径</returns>
        public string SaveSparePartAcceptanceAttachment(string fileContent, string fileName)
        {
            ...
            if (fileContent.Split(',').Length > 1)
            {
                ...
                const string prePath = "SparePartAcceptanceAttachment";
