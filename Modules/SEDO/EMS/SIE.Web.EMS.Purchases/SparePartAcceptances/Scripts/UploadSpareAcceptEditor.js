Ext.define('SIE.Web.EMS.Purchases.SparePartAcceptances.UploadSpareAcceptEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.uploadspareaccepteditor',
                ...
                var win = SIE.Window.show({
                    ...
                    callback: function (btn) {
                        if (btn == "确定".t()) {
                            ...
                            SIE.invokeDataQuery({
                                type: "SIE.Web.EMS.Purchases.SparePartAcceptances.SparePartAcceptanceDataQueryer",
                                method: "SaveSparePartAcceptanceAttachment",
