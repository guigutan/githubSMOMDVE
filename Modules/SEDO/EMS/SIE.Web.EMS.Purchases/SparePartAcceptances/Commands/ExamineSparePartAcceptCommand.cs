...
namespace SIE.Web.EMS.Purchases.SparePartAcceptances.Commands
{
    ...
    /// 审核备件验收
    /// </summary>
    [JsCommand("SIE.Web.EMS.Purchases.SparePartAcceptances.Commands.ExamineSparePartAcceptCommand")]
    public class ExamineSparePartAcceptCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<SparePartAcceptExamineController>().ExamineSparePartAccept(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
