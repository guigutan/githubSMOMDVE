SIE.defineCommand('SIE.Web.EMS.Purchases.SparePartAcceptances.Commands.UploadSpareAcceptCommand', {
    extend: 'SIE.cmd.Add',
    ...
    getEditEntity: function () {
        var model = SIE.getModel('SIE.EMS.Purchases.SparePartAcceptances.SparePartAcceptanceAttachment');
    ...
    showView: function (editEntity) {
        ...
        SIE.AutoUI.getMeta({
            ...
            model: 'SIE.EMS.Purchases.SparePartAcceptances.SparePartAcceptanceAttachment',
            callback: function (res) {
                ...
                SIE.Window.show({
                    title: "文件上传".t(),
                    id: 'UploadSpareAcceptCommand_Window',
                    width: 600,
                    height: 220,
                    items: ui,
                    buttons: []
