...
namespace SIE.Web.EMS.Purchases.EquipmentSetups.Commands
{
    ...
    /// 审核
    /// </summary>
    [JsCommand("SIE.Web.EMS.Purchases.EquipmentSetups.Commands.ExamineEquipmentSetupCommand")]
    public class ExamineEquipmentSetupCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<EquipmentSetupController>().ExamineEquipmentSetup(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
