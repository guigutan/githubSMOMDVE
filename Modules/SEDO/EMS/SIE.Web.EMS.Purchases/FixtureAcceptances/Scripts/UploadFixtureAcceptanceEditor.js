Ext.define('SIE.Web.EMS.Purchases.FixtureAcceptances.UploadFixtureAcceptanceEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.uploadfixtureaccepteditor',
                ...
                var win = SIE.Window.show({
                    ...
                    callback: function (btn) {
                        if (btn == "确定".t()) {
                            ...
                            SIE.invokeDataQuery({
                                type: "SIE.Web.EMS.Purchases.FixtureAcceptances.FixtureAcceptanceDataQueryer",
                                method: "SaveFixtureAcceptanceAttachment",
