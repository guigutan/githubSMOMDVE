...
namespace SIE.EMS.Report.EquipmentMixReport
{
    ...
    [Label("设备综合统计报表查询实体")]
    public class EquipmentMixReportMonViewModelCriteria: Criteria
    {
        ...
        public static readonly IRefIdProperty EquipTypeIdProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRefId(e => e.EquipTypeId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<EquipType> EquipTypeProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRef(e => e.EquipType, EquipTypeIdProperty);
        ...
        public static readonly IRefIdProperty EquipModelIdProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRefId(e => e.EquipModelId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<EquipModel> EquipModelProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRef(e => e.EquipModel, EquipModelIdProperty);
        ...
        public static readonly IRefIdProperty EquipCodeIdProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRefId(e => e.EquipCodeId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<EquipAccountSelect> EquipCodeProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRef(e => e.EquipCode, EquipCodeIdProperty);
        ...
        public static readonly IRefIdProperty UseDepartmentIdProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRefId(e => e.UseDepartmentId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> UseDepartmentProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRef(e => e.UseDepartment, UseDepartmentIdProperty);
        ...
        public static readonly IRefIdProperty WorkShopIdProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRefId(e => e.WorkShopId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> WorkShopProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRef(e => e.WorkShop, WorkShopIdProperty);
        ...
        public static readonly IRefIdProperty WipResourceIdProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRefId(e => e.WipResourceId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> WipResourceProperty =
            P<EquipmentMixReportMonViewModelCriteria>.RegisterRef(e => e.WipResource, WipResourceIdProperty);
        ...
        /// </summary>
        [Label("年份")]
        public static readonly Property<DateTime?> YearProperty = P<EquipmentMixReportMonViewModelCriteria>.Register(e => e.Year);
        ...
        #region 利用率标准 UtilizationCriteria
        /// <summary>
        /// 利用率标准
        /// </summary>
        [Label("利用率标准(%)")]
        public static readonly Property<int> UtilizationCriteriaProperty = P<EquipmentMixReportMonViewModelCriteria>.Register(e => e.UtilizationCriteria);

        /// <summary>
        /// 利用率标准
        /// </summary>
        public int UtilizationCriteria
        {
            get { return this.GetProperty(UtilizationCriteriaProperty); }
            set { this.SetProperty(UtilizationCriteriaProperty, value); }
        }
        #endregion
        ...
        /// </summary>
        [Label("设备名称")]
        public static readonly Property<string> EquipNameProperty = P<EquipmentMixReportMonViewModelCriteria>.Register(e => e.EquipName);
