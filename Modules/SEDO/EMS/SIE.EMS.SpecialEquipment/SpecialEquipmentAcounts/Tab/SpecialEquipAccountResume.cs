...
namespace SIE.EMS.SpecialEquipment.SpecialEquipmentAcounts.Tab
{
    ...
    //[CriteriaQuery]
    [Label("设备履历")]
    public class SpecialEquipAccountResume : EquipAccountResume
    {
        ...
        public static new readonly IRefIdProperty EquipAccountIdProperty =
            P<SpecialEquipAccountResume>.RegisterRefId(e => e.EquipAccountId, ReferenceType.Parent);
        ...
        public static new readonly RefEntityProperty<SpecialEquipmentAccount> EquipAccountProperty =
            P<SpecialEquipAccountResume>.RegisterRef(e => e.EquipAccount, EquipAccountIdProperty);
