...
namespace SIE.EMS.Maintains.AlertPlugs
{
    ...
    [Label("保养计划超时预警")]
    public class MaintainPlanTimeOutAlertPlugConfig : AlertConfig
    {
        ...
        /// </summary>
        [Label("预警触发值")]
        public static readonly Property<int> AlertValueProperty = P<MaintainPlanTimeOutAlertPlugConfig>.Register(e => e.AlertValue);
        ...
        public override void Initialize(string value)
        {
            ...
            var config = JsonConvert.DeserializeObject<MaintainPlanTimeOutAlertPlugConfig>(value);
