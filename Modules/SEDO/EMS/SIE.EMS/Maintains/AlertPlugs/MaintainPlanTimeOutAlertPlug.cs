...
namespace SIE.EMS.Maintains.AlertPlugs
{
    ...
    [Alert("保养计划超时预警", typeof(MaintainPlanTimeOutAlertPlugConfig), typeof(TimeOutAlertResult), "保养计划超时预警")]
    public class MaintainPlanTimeOutAlertPlug : AlertBase
    {
        ...
        public override AlertResultBase Run()
        {
            ...
            var config = this.Context.Config as MaintainPlanTimeOutAlertPlugConfig;
            var planList = RT.Service.Resolve<MaintainController>().GetTimeOutMaintainPlanList();
        ...
        private string SetBody(TimeOutAlertResult result, EntityList<MaintainPlan> bills)
        {
            ...
            message.Append("</br>");
            message.Append("&nbsp;&nbsp;");
            message.Append("您好，保养计划超时预警推送：".L10N());
            message.Append("</br></br>");
            message.Append(Environment.NewLine);
            message.Append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
            message.Append("保养计划超时预警的设备清单，请及时保养".L10N());
