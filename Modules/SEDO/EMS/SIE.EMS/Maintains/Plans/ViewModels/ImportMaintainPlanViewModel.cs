...
namespace SIE.EMS.Maintains.Plans.ViewModels
{
    ...
    /// </summary>
    [RootEntity]
    public class ImportMaintainPlanViewModel : ViewModel
    {
        ...
        /// </summary>
        [Label("导入文件")]
        public static readonly Property<string> ImportFilePathProperty = P<ImportMaintainPlanViewModel>.Register(e => e.ImportFilePath);
        ...
        /// </summary>
        [Label("导入成功数量")]
        public static readonly Property<int> ImportSuccessAmountProperty = P<ImportMaintainPlanViewModel>.Register(e => e.ImportSuccessAmount);
        ...
        /// </summary>
        [Label("导入失败数量")]
        public static readonly Property<int> ImportFailAmountProperty = P<ImportMaintainPlanViewModel>.Register(e => e.ImportFailAmount);
        ...
        /// </summary>
        [Label("导入处理消息")]
        public static readonly Property<string> ImportProcessMsgProperty = P<ImportMaintainPlanViewModel>.Register(e => e.ImportProcessMsg);
    ...
    /// 备件导入 视图配置
    /// </summary>
    class ImportMaintainPlanViewModelConfig : WebViewConfig<ImportMaintainPlanViewModel>
    {
        /// <summary>
        /// 配置默认试图
        /// </summary>
