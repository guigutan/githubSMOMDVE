...
namespace SIE.EMS.Maintains.Plans
{
    ...
    [Label("保养计划备件申请")]
    public partial class MaintainPlanSparePartApl : DataEntity
    {
        ...
        public static readonly IRefIdProperty MaintainPlanIdProperty =
            P<MaintainPlanSparePartApl>.RegisterRefId(e => e.MaintainPlanId, ReferenceType.Parent);
        ...
        public static readonly RefEntityProperty<MaintainPlan> MaintainPlanProperty =
            P<MaintainPlanSparePartApl>.RegisterRef(e => e.MaintainPlan, MaintainPlanIdProperty);
        ...
        /// </summary>
        [Label("备件")]
        public static readonly IRefIdProperty SparePartIdProperty = P<MaintainPlanSparePartApl>.RegisterRefId(e => e.SparePartId, ReferenceType.Normal);
        ...
        /// 备件基础数据
        /// </summary>
        public static readonly RefEntityProperty<SparePart> SparePartProperty = P<MaintainPlanSparePartApl>.RegisterRef(e => e.SparePart, SparePartIdProperty);
        ...
        /// </summary>
        [Label("申请数量")]
        public static readonly Property<int> ApplyQtyProperty = P<MaintainPlanSparePartApl>.Register(e => e.ApplyQty);
        ...
        public static readonly IRefIdProperty OutStockWarehouseIdProperty =
            P<MaintainPlanSparePartApl>.RegisterRefId(e => e.OutStockWarehouseId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Warehouse> OutStockWarehouseProperty =
            P<MaintainPlanSparePartApl>.RegisterRef(e => e.OutStockWarehouse, OutStockWarehouseIdProperty);
        ...
        public static readonly IRefIdProperty ApplyDetailIdProperty =
            P<MaintainPlanSparePartApl>.RegisterRefId(e => e.ApplyDetailId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<ApplyDetail> ApplyDetailProperty =
            P<MaintainPlanSparePartApl>.RegisterRef(e => e.ApplyDetail, ApplyDetailIdProperty);
        ...
        /// </summary>
        [Label("备注")]
        public static readonly Property<string> RemarkProperty = P<MaintainPlanSparePartApl>.Register(e => e.Remark);
        ...
        /// </summary>
        [Label("是否已申请")]
        public static readonly Property<bool> IsApplyProperty = P<MaintainPlanSparePartApl>.Register(e => e.IsApply);
        ...
        /// </summary>
        [Label("库存数")]
        public static readonly Property<decimal> StoreQtyProperty = P<MaintainPlanSparePartApl>.Register(e => e.StoreQty);
        ...
        /// </summary>
        [Label("备件编码")]
        public static readonly Property<string> SparePartCodeViewProperty = P<MaintainPlanSparePartApl>.RegisterView(e => e.SparePartCodeView, p => p.SparePart.SparePartCode);
        ...
        /// </summary>
        [Label("备件名称")]
        public static readonly Property<string> SparePartNameViewProperty = P<MaintainPlanSparePartApl>.RegisterView(e => e.SparePartNameView, p => p.SparePart.SparePartName);
        ...
        /// </summary>
        [Label("规格型号")]
        public static readonly Property<string> SpecificationViewProperty = P<MaintainPlanSparePartApl>.RegisterView(e => e.SpecificationView, p => p.SparePart.Specification);
        ...
        /// </summary>
        [Label("单位")]
        public static readonly Property<string> UnitViewProperty = P<MaintainPlanSparePartApl>.RegisterView(e => e.UnitView, p => p.SparePart.Unit.Name);
        ...
        /// </summary>
        [Label("申请单状态")]
        public static readonly Property<AuditState> AppStateViewProperty = P<MaintainPlanSparePartApl>.RegisterView(e => e.AppStateView, p => p.ApplyDetail.SparePartApp.AuditState);
        ...
        /// </summary>
        [Label("申请单号")]
        public static readonly Property<string> ApplyNoViewProperty = P<MaintainPlanSparePartApl>.RegisterView(e => e.ApplyNoView, p => p.ApplyDetail.SparePartApp.No);
    ...
    /// 保养计划备件申请 实体配置
    /// </summary>
    internal class MaintainPlanSparePartAplConfig : EntityConfig<MaintainPlanSparePartApl>
    {
        protected override void AddValidations(IValidationDeclarer rules)
        {
            base.AddValidations(rules);
            rules.AddRule(MaintainPlanSparePartApl.RemarkProperty, new StringLengthRangeRule() { Max = 2000 });
        }
        ...
        {
            Meta.MapTable("EMS_MAINTAIN_PLAN_SP_APL").MapAllProperties();
            Meta.Property(MaintainPlanSparePartApl.RemarkProperty).ColumnMeta.HasLength(4000);
            Meta.Property(MaintainPlanSparePartApl.StoreQtyProperty).DontMapColumn();
            Meta.EnablePhantoms();
        }
    }
}