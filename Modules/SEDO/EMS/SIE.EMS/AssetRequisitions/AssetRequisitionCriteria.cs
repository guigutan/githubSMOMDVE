...
namespace SIE.EMS.AssetRequisitions
{
	...
	[Label("资产领用查询实体")]
	public partial class AssetRequisitionCriteria : Criteria
	{
		...
		/// </summary>		
		[Label("领用单号")]
		public static readonly Property<string> RequisitionNoProperty = P<AssetRequisitionCriteria>.Register(e => e.RequisitionNo);
        ...
        /// </summary>
        [Label("工厂")]
        public static readonly IRefIdProperty QureyFactoryIdProperty = P<AssetRequisitionCriteria>.RegisterRefId(e => e.QureyFactoryId, ReferenceType.Normal);
        ...
        /// 工厂
        /// </summary>
        public static readonly RefEntityProperty<Enterprise> QureyFactoryProperty = P<AssetRequisitionCriteria>.RegisterRef(e => e.QureyFactory, QureyFactoryIdProperty);
		...
		/// </summary>
		[Label("业务类型")]
		public static readonly Property<RequisitionType?> RequisitionTypeProperty = P<AssetRequisitionCriteria>.Register(e => e.RequisitionType);
		...
		/// </summary>
		[Label("资产对象")]
		public static readonly Property<AssetObject?> AssetObjectProperty = P<AssetRequisitionCriteria>.Register(e => e.AssetObject);
        ...
        public static readonly IRefIdProperty ApplyDepartmentIdProperty =
            P<AssetRequisitionCriteria>.RegisterRefId(e => e.ApplyDepartmentId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> ApplyDepartmentProperty =
            P<AssetRequisitionCriteria>.RegisterRef(e => e.ApplyDepartment, ApplyDepartmentIdProperty);
        ...
        public static readonly IRefIdProperty LendingDepartmentIdProperty =
            P<AssetRequisitionCriteria>.RegisterRefId(e => e.LendingDepartmentId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Enterprise> LendingDepartmentProperty =
            P<AssetRequisitionCriteria>.RegisterRef(e => e.LendingDepartment, LendingDepartmentIdProperty);
        ...
        /// </summary>
        [Label("发放仓库")]
        public static readonly IRefIdProperty WarehouseIdProperty = P<AssetRequisitionCriteria>.RegisterRefId(e => e.WarehouseId, ReferenceType.Normal);
        ...
        /// 发放仓库
        /// </summary>
        public static readonly RefEntityProperty<Warehouse> WarehouseProperty = P<AssetRequisitionCriteria>.RegisterRef(e => e.Warehouse, WarehouseIdProperty);
        ...
        /// </summary>
        [Label("审核状态")]
        public static readonly Property<ApprovalStatus?> ApprovalStatusProperty = P<AssetRequisitionCriteria>.Register(e => e.ApprovalStatus);
        ...
        /// </summary>
        [Label("发放状态")]
        public static readonly Property<IssueStatus?> IssueStatusProperty = P<AssetRequisitionCriteria>.Register(e => e.IssueStatus);
        ...
        {
            get { return this.GetProperty(IssueStatusProperty); }
            set { this.SetProperty(IssueStatusProperty, value); }
        }
        #endregion
        ...
        public static readonly IRefIdProperty EmployeeIdProperty =
            P<AssetRequisitionCriteria>.RegisterRefId(e => e.EmployeeId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Employee> EmployeeProperty =
            P<AssetRequisitionCriteria>.RegisterRef(e => e.Employee, EmployeeIdProperty);
        ...
        #region 逾期未归还 IsExpired
        /// <summary>
        /// 逾期未归还
        /// </summary>
        [Label("逾期未归还")]
        public static readonly Property<bool> IsExpiredProperty = P<AssetRequisitionCriteria>.Register(e => e.IsExpired);
        ...
        {
            get { return this.GetProperty(IsExpiredProperty); }
            set { this.SetProperty(IsExpiredProperty, value); }
        }
        #endregion
        ...
        /// </summary>
        [Label("创建日期")]
        public static readonly Property<DateRange> CreateDateProperty = P<AssetRequisitionCriteria>.Register(e => e.CreateDate);
		...
		{
			return RT.Service.Resolve<AssetRequisitionController>().GetAssetRequisitionList(this);
