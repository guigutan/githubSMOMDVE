...
namespace SIE.EMS.Equipments.Accounts
{
    ...
    [Label("设备台账点检项目")]
    public partial class EquipAccountCheckProject : EquipAccountCheckProjectBase
    {
        #region 设备台账 EquipAccount
        /// <summary>
        /// 设备台账Id
        /// </summary>
        public static readonly IRefIdProperty EquipAccountIdProperty = P<EquipAccountCheckProject>.RegisterRefId(e => e.EquipAccountId, ReferenceType.Parent);
        ...
        /// 设备台账Id
        /// </summary>
        public static readonly RefEntityProperty<EquipAccount> EquipAccountProperty = P<EquipAccountCheckProject>.RegisterRef(e => e.EquipAccount, EquipAccountIdProperty);
        ...
        /// </summary>
        [Label("设备编码")]
        public static readonly Property<string> EquipAccountCodeProperty = P<EquipAccountCheckProject>.RegisterView(e => e.EquipAccountCode, p => p.EquipAccount.Code);
        ...
        /// </summary>
        [Label("设备名称")]
        public static readonly Property<string> EquipAccountNameProperty = P<EquipAccountCheckProject>.RegisterView(e => e.EquipAccountName, p => p.EquipAccount.Name);
    ...
    /// 设备台账点检项目 实体配置
    /// </summary>
    internal class EquipAccountCheckProjectConfig : EntityConfig<EquipAccountCheckProject>
    {
        /// <summary>
        /// 配置元数据
        /// </summary>
		...
		protected override void AddValidations(IValidationDeclarer rules)
        {
            rules.AddRule(new HandlerRule()
            {
                Handler = (o, e) =>
                {
                    var para = o.CastTo<EquipAccountCheckProject>();
