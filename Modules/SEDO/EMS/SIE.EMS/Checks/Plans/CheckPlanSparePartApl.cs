...
namespace SIE.EMS.Checks.Plans
{
    ...
    [Label("点检计划备件申请")]
    public partial class CheckPlanSparePartApl : DataEntity
    {
        ...
        public static readonly IRefIdProperty CheckPlanIdProperty =
            P<CheckPlanSparePartApl>.RegisterRefId(e => e.CheckPlanId, ReferenceType.Parent);
        ...
        public static readonly RefEntityProperty<CheckPlan> CheckPlanProperty =
            P<CheckPlanSparePartApl>.RegisterRef(e => e.CheckPlan, CheckPlanIdProperty);
        ...
        /// </summary>
        [Label("备件")]
        public static readonly IRefIdProperty SparePartIdProperty = P<CheckPlanSparePartApl>.RegisterRefId(e => e.SparePartId, ReferenceType.Normal);
        ...
        /// 备件基础数据
        /// </summary>
        public static readonly RefEntityProperty<SparePart> SparePartProperty = P<CheckPlanSparePartApl>.RegisterRef(e => e.SparePart, SparePartIdProperty);
        ...
        /// </summary>
        [Label("申请数量")]
        public static readonly Property<int> ApplyQtyProperty = P<CheckPlanSparePartApl>.Register(e => e.ApplyQty);
        ...
        public static readonly IRefIdProperty OutStockWarehouseIdProperty =
            P<CheckPlanSparePartApl>.RegisterRefId(e => e.OutStockWarehouseId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<Warehouse> OutStockWarehouseProperty =
            P<CheckPlanSparePartApl>.RegisterRef(e => e.OutStockWarehouse, OutStockWarehouseIdProperty);
        ...
        public static readonly IRefIdProperty ApplyDetailIdProperty =
            P<CheckPlanSparePartApl>.RegisterRefId(e => e.ApplyDetailId, ReferenceType.Normal);
        ...
        public static readonly RefEntityProperty<ApplyDetail> ApplyDetailProperty =
            P<CheckPlanSparePartApl>.RegisterRef(e => e.ApplyDetail, ApplyDetailIdProperty);
        ...
        /// </summary>
        [Label("备注")]
        public static readonly Property<string> RemarkProperty = P<CheckPlanSparePartApl>.Register(e => e.Remark);
        ...
        /// </summary>
        [Label("是否已申请")]
        public static readonly Property<bool> IsApplyProperty = P<CheckPlanSparePartApl>.Register(e => e.IsApply);
        ...
        /// </summary>
        [Label("库存数")]
        public static readonly Property<decimal> StoreQtyProperty = P<CheckPlanSparePartApl>.Register(e => e.StoreQty);
        ...
        /// </summary>
        [Label("备件编码")]
        public static readonly Property<string> SparePartCodeViewProperty = P<CheckPlanSparePartApl>.RegisterView(e => e.SparePartCodeView, p => p.SparePart.SparePartCode);
        ...
        /// </summary>
        [Label("备件名称")]
        public static readonly Property<string> SparePartNameViewProperty = P<CheckPlanSparePartApl>.RegisterView(e => e.SparePartNameView, p => p.SparePart.SparePartName);
        ...
        /// </summary>
        [Label("规格型号")]
        public static readonly Property<string> SpecificationViewProperty = P<CheckPlanSparePartApl>.RegisterView(e => e.SpecificationView, p => p.SparePart.Specification);
        ...
        /// </summary>
        [Label("单位")]
        public static readonly Property<string> UnitViewProperty = P<CheckPlanSparePartApl>.RegisterView(e => e.UnitView, p => p.SparePart.Unit.Name);
        ...
        /// </summary>
        [Label("申请单状态")]
        public static readonly Property<AuditState> AppStateViewProperty = P<CheckPlanSparePartApl>.RegisterView(e => e.AppStateView, p => p.ApplyDetail.SparePartApp.AuditState);
        ...
        /// </summary>
        [Label("申请单号")]
        public static readonly Property<string> ApplyNoViewProperty = P<CheckPlanSparePartApl>.RegisterView(e => e.ApplyNoView, p => p.ApplyDetail.SparePartApp.No);
    ...
    /// 点检计划配件更换 实体配置
    /// </summary>
    internal class CheckPlanSparePartAplConfig : EntityConfig<CheckPlanSparePartApl>
    {
        protected override void AddValidations(IValidationDeclarer rules)
        {
            base.AddValidations(rules);
            rules.AddRule(CheckPlanSparePartApl.RemarkProperty, new StringLengthRangeRule() { Max = 2000 });
        }
        ...
        {
            Meta.MapTable("EMS_CHECK_PLAN_SP_APL").MapAllProperties();
            Meta.Property(CheckPlanSparePartApl.RemarkProperty).ColumnMeta.HasLength(4000);
            Meta.Property(CheckPlanSparePartApl.StoreQtyProperty).DontMapColumn();
            Meta.EnablePhantoms();
        }
    }
}