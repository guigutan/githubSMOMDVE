...
namespace SIE.EMS.Checks.AlertPlugs
{
    ...
    [Alert("点检计划超时预警", typeof(CheckPlanTimeOutAlertPlugConfig), typeof(TimeOutAlertResult), "点检计划超时预警")]
    public class CheckPlanTimeOutAlertPlug : AlertBase
    {
            ...
            @"<html>
                ...
                <body>
                    ...
                    <table border='1' cellspacing='0' style='margin-left:25px'>
                        <tr style='background-color:red'>{2}</tr>
                        {3}
                    </table></br>                   
                   </div>
                </body>
        ...
        {
            var config = this.Context.Config as CheckPlanTimeOutAlertPlugConfig;
            var planList = RT.Service.Resolve<CheckPlanController>().GetTimeOutCheckPlanList();
            if (planList.Count <= 0)
            {
                return null;
            }
            var result = new TimeOutAlertResult();
        ...
        private string SetBody(TimeOutAlertResult result, EntityList<CheckPlan> bills)
        {
            ...
            message.Append("</br>");
            message.Append("&nbsp;&nbsp;");
            message.Append("您好，点检计划超时预警推送：".L10N());
            message.Append("</br></br>");
            message.Append(Environment.NewLine);
            message.Append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
            message.Append("点检计划超时预警的设备清单，请及时点检".L10N());
    ...
    /// </summary>
    [Serializable]
    public class TimeOutAlertResult : AlertResultBase
    {
        /// <summary>
        /// 推送信息
        /// </summary>
