...
namespace SIE.EMS.Checks.AlertPlugs
{
    ...
    [Label("点检计划超时预警")]
    public class CheckPlanTimeOutAlertPlugConfig : AlertConfig
    {
        ...
        /// </summary>
        [Label("预警触发值")]
        public static readonly Property<int> AlertValueProperty = P<CheckPlanTimeOutAlertPlugConfig>.Register(e => e.AlertValue);
        ...
        public override void Initialize(string value)
        {
            ...
            var config = JsonConvert.DeserializeObject<CheckPlanTimeOutAlertPlugConfig>(value);
