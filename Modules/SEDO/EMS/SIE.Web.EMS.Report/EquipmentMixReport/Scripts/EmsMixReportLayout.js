Ext.define('SIE.Web.EMS.Report.EquipmentMixReport.Scripts.EmsMixReportLayout', {
    extend: 'SIE.autoUI.layouts.Common',
    xtype: 'EdoMixReportLayout',
    _isRunning: false,
    _token: null,
    _criteria: null,
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [
                        ...
                        {
                            xtype: 'displayfield',
                            id: 'displayMixEquipmentCountId',
                            name: 'displayMixEquipmentCountId',
                            value: '本次统计设备数:0台'.t(),
                            fieldLabel: '',
                            flex: 1
                        }
    ...
    */
    createLineChart: function (me) {
        return Ext.create('SIE.EMS.Report.EquipmentMixReport.Scripts.EmsEquipmentChart', {
            id: 'edoRateChartId',
            region: 'south',
            layout: 'fit',
            width: "100%",
    ...
    createNgListView: function () {
        var meta = null;
        SIE.AutoUI.getMeta({
            model: 'SIE.EMS.Report.EquipmentMixReport.EquipmentMixReportMonViewModel',
            ignoreCommands: true,
            isDetail: false,
            ignoreQuery: false,
            async: false,
        ...
        //meta.gridConfig.title = (new Date()).getFullYear() + "年综合年度报表".t();
    ...
    loadReportData: function (criteria, token) {
        ...
        try {
            ...
            SIE.invokeDataQuery({
                ...
                action: 'queryer',
                async: true,
                type: 'SIE.Web.EMS.Report.EquipmentMixReport.EmsMixReportDataQueryer',
                token: token,
    ...
    bindReportInfos: function (passRateInfos) {
        this._listView.getData().loadData(passRateInfos.EsdNgList);

        var passRateData = passRateInfos.EsdPassRateReport.EsdPassRateDatas;
        var lineChart = Ext.getCmp('edoRateChartId');
        if (lineChart) {
        ...
        var displayEquipmentConutId = Ext.getCmp("displayMixEquipmentCountId");
