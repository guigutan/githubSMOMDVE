Ext.define('SIE.EMS.Report.EquipmentMixReport.Scripts.EmsEquipmentChartController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.EmsEquipmentChartController',
    ...
    */
    ...
    onLineChartSeriesTooltipRender: function (tooltip, record, item) {
        if (record) {
            ...
            tooltip.setHtml(date + item.series._title + ':' + ((record.get(item.series._yField)) * 100).toFixed(1) + '%');
        }
    },
});