SIE.defineCommand('SIE.Web.EMS.Report.MttrAndMtbfReports.Commands.MttrAndMtbfReportExportCommand', {
    extend: 'SIE.Web.EMS.Report.MttrAndMtbfReports.Commands.ExportCommandBase',
    ...
    getExportInfo: function (view) {
        var me = this;
        var esdMainPanel = Ext.getCmp("MttrAndMtbfReportMainPanel");
        var rateChart = Ext.getCmp("MttrAndMtbfReportLineChartId");
        var ngPersonChart = Ext.getCmp("MttrAndMtbfReportBarChartId");
        ...
        ngPersonChart.items.items.forEach(
            function (p) {
                pictures.push(p.getImage());
            });  //图表截图
        var exportInfo = {
