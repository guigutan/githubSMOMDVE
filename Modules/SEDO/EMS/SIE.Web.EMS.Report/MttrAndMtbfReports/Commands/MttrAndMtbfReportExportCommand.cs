...
namespace SIE.Web.EMS.Report.MttrAndMtbfReports.Commands
{
    /// <summary>
    /// 导出
    /// </summary>
    public class MttrAndMtbfReportExportCommand : ViewCommand<ViewArgs>
    {
        /// <summary>
        /// 执行导出，保存至Excel
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            ReportExcelHelper excel = new ReportExcelHelper();
