Ext.define('SIE.Web.EMS.Report.MttrAndMtbfReports.Scripts.MttrAndMtbfReportBarChartController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.MttrAndMtbfReportBarChartController',
    ...
    */
    ...
    onLineChartSeriesTooltipRender: function (tooltip, record, item) {
        if (record) {
            ...
            tooltip.setHtml(date + item.series._title + ':' + (record.get(item.series._yField)).toFixed(4) * 100 + '%');
        }
    },
});