...
namespace SIE.Web.EMS.Report.MttrAndMtbfReports
{
    ...
    /// MTTR/MTBF统计报表视图配置
    /// </summary>
    public class MttrAndMtbfReportViewModelCriteriaViewConfig : WebViewConfig<MttrAndMtbfReportViewModelCriteria>
    {
        /// <summary>
        /// 列表视图配置
        /// </summary>
        protected override void ConfigQueryView()
        {
            ...
            {
                var criteria = e as MttrAndMtbfReportViewModelCriteria;
            ...
            {
                var criteria = e as MttrAndMtbfReportViewModelCriteria;
                var equipList = RT.Service.Resolve<EquipController>().GetEquipAccounts(c, criteria.EquipModelId, criteria.EquipTypeId, r);
                equipList.ForEach(equip => { equip.TreePId = null; });
                return equipList;
            }).Show();
            ...
            View.Property(p => p.Year).UseYearEditor().DefaultValue(DateTime.Now);
        }
    }
}
