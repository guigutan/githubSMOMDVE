SIE.defineCommand('SIE.Web.EMS.SpareParts.OutDepotHandovers.Commands.WholeBillHandoverCommand', {
    extend: 'SIE.cmd.Edit',
    meta: { text: "整单交接", group: "edit", iconCls: "icon-PlaylistCheck icon-blue" },
    ...
    execute: function (view, source) {
        ...
        SIE.Msg.askQuestion("是否将此单据进行整单接收？".t(),
            function () {
                view.execute({
                    data: indata,
                    async: false,
