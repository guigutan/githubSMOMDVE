SIE.defineCommand('SIE.Web.EMS.SpareParts.Commands.EnableSparePartCommand', {
    extend: 'SIE.cmd.ListEditableBase',
    meta: { text: "启用", group: "edit", iconCls: "icon-Play icon-green" },
    selectedItems: [],
    ...
    execute: function (listview, source) {
        SIE.Msg.askQuestion('是否启用这些备件?'.t(),
            function () {
