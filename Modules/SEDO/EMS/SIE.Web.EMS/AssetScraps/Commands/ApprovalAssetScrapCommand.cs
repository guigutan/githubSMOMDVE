...
namespace SIE.Web.EMS.AssetScraps.Commands
{
    /// <summary>
    /// 审核命令
    /// </summary>
    public class ApprovalAssetScrapCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<AssetScrapController>().ApprovalAssetScraps(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
