...
namespace SIE.Web.EMS.InventoryBalances.Commands
{
    ...
    /// 审核
    /// </summary>
    [JsCommand("SIE.Web.EMS.InventoryBalances.Commands.ExamineBalanceCommand")]
    public class ExamineBalanceCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            //只能单选 
            RT.Service.Resolve<InventoryBalanceController>().ExamineBalance(args.SelectedIds[0], info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
