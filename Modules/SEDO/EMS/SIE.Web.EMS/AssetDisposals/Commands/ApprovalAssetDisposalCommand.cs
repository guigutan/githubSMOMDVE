...
namespace SIE.Web.EMS.AssetDisposals.Commands
{
    ...
    /// 审核命令
    /// </summary>
    public class ApprovalAssetDisposalCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<AssetDisposalController>().ApprovalAssetDisposals(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
