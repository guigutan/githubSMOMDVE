SIE.defineCommand('SIE.Web.EMS.AssetDisposals.Commands.ApprovalAssetDisposalCommand', {
    ...
    execute: function (view, source) {
        var win = SIE.Window.show({
            ...
            items: {
                ...
                items: [{
                    xtype: 'combobox',
                    id: 'AssetDisposalsApproval_Result',
                    name: 'AssetDisposalsApprovalResult',
                    margin: '5',
                    fieldLabel: '审核结果'.t(),
                    editable: false,
                    queryMode: 'local',
                    ...
                    xtype: 'textareafield',
                    grow: true,
                    id: 'AssetDisposalsApproval_Opinions',
                    name: 'Opinions',
                    margin: '5',
                    fieldLabel: '审核意见'.t(),
                    anchor: '100%'
            ...
            id: "AssetDisposalsApprovalCommand001",
            callback: function (btn) {
                if (btn == "确定".t()) {
                    var selectModels = view.getSelection();
                    var selectIds = view.getSelectionIds(selectModels);
                    var result = Ext.getCmp('AssetDisposalsApproval_Result');
                    var opinions = Ext.getCmp('AssetDisposalsApproval_Opinions');
                    var postdata = {
