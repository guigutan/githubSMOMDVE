Ext.define('SIE.Web.EMS.InventoryPlans.UploadInventoryPlanPhotoEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.uploadinventoryplanphotoeditor',
                    ...
                    callback: function (btn) {
                        if (btn == "确定".t()) {
                            ...
                            SIE.invokeDataQuery({
                                ...
                                method: "SaveInventoryPlanPhotoNoSave",
                                ...
                                callback: function (result) {
                                    if (result.Success) {
                                        if (result.Result != "") {
                                            detailView.mainView.getCurrent().setPhotoFilePath(result.Result);
                                            return false;
                                        }
                                    }
                                },
