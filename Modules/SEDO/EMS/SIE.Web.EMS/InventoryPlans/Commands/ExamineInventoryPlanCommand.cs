...
namespace SIE.Web.EMS.InventoryPlans.Commands
{
    ...
    /// 审核
    /// </summary>
    [JsCommand("SIE.Web.EMS.InventoryPlans.Commands.ExamineInventoryPlanCommand")]
    public class ExamineInventoryPlanCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            //只能单选
            RT.Service.Resolve<InventoryPlanController>().ExamineInventoryPlan(args.SelectedIds[0], info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
