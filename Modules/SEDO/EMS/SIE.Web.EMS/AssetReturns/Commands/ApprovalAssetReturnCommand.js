SIE.defineCommand('SIE.Web.EMS.AssetReturns.Commands.ApprovalAssetReturnCommand', {
    ...
    execute: function (view, source) {
        var win = SIE.Window.show({
            ...
            items: {
                ...
                items: [{
                    xtype: 'combobox',
                    id: 'AssetReturnsApproval_Result',
                    name: 'AssetReturnsApprovalResult',
                    margin: '5',
                    fieldLabel: '审核结果'.t(),
                    editable: false,
                    queryMode: 'local',
                    ...
                    xtype: 'textareafield',
                    grow: true,
                    id: 'AssetReturnsApproval_Opinions',
                    name: 'Opinions',
                    margin: '5',
                    fieldLabel: '审核意见'.t(),
                    anchor: '100%'
            ...
            id: "AssetReturnsApprovalCommand001",
            callback: function (btn) {
                if (btn == "确定".t()) {
                    var selectModels = view.getSelection();
                    var selectIds = view.getSelectionIds(selectModels);
                    var result = Ext.getCmp('AssetReturnsApproval_Result');
                    var opinions = Ext.getCmp('AssetReturnsApproval_Opinions');
                    var postdata = {
