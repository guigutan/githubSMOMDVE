...
namespace SIE.Web.EMS.AssetReturns.Commands
{
    ...
    /// 审核命令
    /// </summary>
    public class ApprovalAssetReturnCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<AssetReturnController>().ApprovalAssetReturns(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
