...
namespace SIE.Web.EMS.Lubrications.Commands
{
    ...
    /// 润滑记录审批
    /// </summary>
    public class LubricationApprovalCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            {
                throw new ValidationException("润滑记录数据参数不能为空".L10N());
            }
            var info = args.Data.ToJsonObject<ExamineInfo>();
            if (info == null)
            {
                throw new ValidationException("润滑记录信息异常".L10N());
            }
            ...
            RT.Service.Resolve<LubricationController>().LubricationApproval(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
