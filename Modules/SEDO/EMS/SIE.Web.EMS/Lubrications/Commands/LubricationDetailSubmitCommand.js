SIE.defineCommand('SIE.Web.EMS.Lubrications.Commands.LubricationDetailSubmitCommand', {
    ...
    canExecute: function (view) {
        ...
        if (current) {
            ...
            if (LubricationStatus === SIE.EMS.Enums.LubricationStatus.Pending.value || LubricationStatus === SIE.EMS.Enums.LubricationStatus.Doing.value
            ) {
                return true;
            } else {
                return false;
