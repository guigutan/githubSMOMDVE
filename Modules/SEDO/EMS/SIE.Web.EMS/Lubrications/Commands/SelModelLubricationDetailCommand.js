SIE.defineCommand('SIE.Web.EMS.Lubrications.Commands.SelModelLubricationDetailCommand', {
    ...
    execute: function (listView, source) {
        ...
        if (!this.viewMeta) {
            SIE.AutoUI.getMeta({
                ...
                model: "SIE.EMS.Lubrications.ViewModels.SelLubricationDetailViewModel",
                callback: function (res) {
                    ...
                    if (dialogView.getRelations() && dialogView.getRelations().length > 0 && dialogView.getRelations()[0].getTarget() && view.getView().getRelations()[0].getTarget().viewGroup === 'QueryView') {
                        ...
                        queryView.getData().data.EquipAccountId = wodata.EquipAccountId;
                        queryView.getData().data.DepartmentId = wodata.DepartmentId;
                        ...
                        var win = SIE.Window.show({
                            ...
                            height: 500,
                            items: ui,
                            id: "SelInspectionProjectViewModel001",
                            callback: function (btn) {
                                if (btn == "确定".t()) {
                                    ...
                                    for (var i = 0; i < datas.length; i++) {
                                        ...
                                        newData.data.ProjectName = resdata.data.ProjectName;
                                        ...
                                        newData.data.ProjectCycle = resdata.data.ProjectCycle;
                                        newData.data.WarningPeriod = resdata.data.WarningPeriod;
                                        newData.data.LubricatingType = resdata.data.LubricatingType;
                                        newData.data.NotSubmit = resdata.data.NotSubmit;
