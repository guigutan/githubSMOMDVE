SIE.defineCommand('SIE.Web.EMS.ViceTransfers.Commands.ShutdownCommand', {
    ...
    canExecute: function (view) {
        ...
        SIE.each(selectModels, function (model) {
            if ((model.data.TransferStatus == 10 || model.data.TransferStatus == 30) && model.data.ApprovalStatus == 40) {
                res = true
                return res;
            }
            else {
