...
namespace SIE.Web.EMS.MainenanceProjects.Commands
{
    /// <summary>
    /// 点检保养项目维护导入
    /// </summary>
    public class ProjectDetailImportCommand : ImportCommandBase
    {
        /// <summary>
        /// 导入数据
        /// </summary>
        ...
        {
            const string templateFileName = "点检保养项目导入模板.xlsx";
        ...
        {
            return typeof(ImportProjectDetailHandle);
        }
    }
}
