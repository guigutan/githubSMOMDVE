SIE.defineCommand('SIE.Web.EMS.Equipments.Accounts.Commands.SelEquipAccountCommand', {
    extend: 'SIE.cmd.LookupCommandBase',
    userConfig: {
        dataParams: { specKeyPrototyName: 'Id', targetClassName: 'SIE.Equipments.EquipAccounts.EquipAccountSelect' }
    },
    ...
    execute: function (view, source) {
        ...
        SIE.AutoUI.getMeta({
            ...
            callback: function (res) {
                ...
                ui._view._relations[0]._target._current.setAccountUseState(5);
