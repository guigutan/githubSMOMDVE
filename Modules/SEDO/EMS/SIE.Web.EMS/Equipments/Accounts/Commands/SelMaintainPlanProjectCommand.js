SIE.defineCommand('SIE.Web.EMS.Equipments.Accounts.Commands.SelMaintainPlanProjectCommand', {
        ...
        if (selections && selections.length > 0) {
            ...
            selections.forEach(function (sel) {
                ...
                if (me._sourceViewSelectItems.indexOf(projectDetailId) === -1) {
                    ...
                    if (result) {
                        var entity = me.createMaintainProject(projectDetail);
                        lists.push(entity);
                    }
                }
            });
    ...
    */
    createMaintainProject: function (projectDetail) {
        var me = this;
        var entity = Ext.create("SIE.EMS.Equipments.Accounts.EquipAccountMaintainProject");
        ...
        //entity.setProjectCategory(projectDetail.Category);
        //entity.setCycleType(projectDetail.CycleType);
        //entity.setProjectCycle(projectDetail.ProjectCycle);
    ...
    */
    onLoad: function (store, records, successful, operation, eOpts) {
        var me = this;
        var entitys = store.data.items.where(function (p) { return p.getProjectType() === 5 });
    ...
    */
    execute: function (view, source) {
        var me = this;
        var addMaintainPlanVM = view.getParent().getData();
        me._equipAccountId = addMaintainPlanVM.getEquipAccountId();
        if (me._equipAccountId == null) {
            SIE.Msg.showInstantMessage('请选择设备!'.t());
            return false;
        }
        me.EquipAccountCode = addMaintainPlanVM.getEquipAccountId_Display();
        me.EquipAccountName = addMaintainPlanVM.getMachineNo();
        SIE.AutoUI.getMeta({
