Ext.define('SIE.Web.EMS.Equipments.Scripts.AddEquipAccountBehavior',
    {
        SourceEquipId: null,
        /**
        * view生命周期函数--view聚合后
        ...
        */
        ...
        bindEvent: function (view, entity) {
            var me = this;
            view.childCheckView = view.findChild('SIE.EMS.Equipments.Accounts.EquipAccountCheckProject');
            view.childCalibrationView = view.findChild('SIE.EMS.Equipments.Accounts.EquipAccountCalibrationProject');
            view.childMaintainView = view.findChild('SIE.EMS.Equipments.Accounts.EquipAccountMaintainProject');
            view.childLocationView = view.findChild('SIE.Equipments.EquipAccountLocations.EquipAccountLocation');
            view.childLubricationView = view.findChild('SIE.EMS.Equipments.Accounts.EquipAccountLubricationProject');
