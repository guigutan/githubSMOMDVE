SIE.defineCommand('SIE.Web.EMS.Equipments.Models.Commands.SelRepairProjectCommand', {
            ...
            if (items.length > 0) {
                ...
                me._targetView.execute({
                    ...
                    success: function (res) {
                        ...
                        //    //me.view.getData().removeAll();
                        //    res.Result.forEach(item => {
                        //        if (me.view.getData().getData().items.findIndex(m => m.getProjectDetailId()=== item.ProjectDetailId) < 0) {
                        //            item.ProjectDetailId_Display = item.ProjectName;
