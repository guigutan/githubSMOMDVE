...
using SIE.EMS.Equipments.Models.ImportEquipModel;
...
namespace SIE.Web.EMS.Equipments.Models.Commands
{
    ...
    /// 设备型号项目导入命令
    /// </summary>
    public class EquipModelProjectImportCommand : ImportCommandBase
    {
        /// <summary>
        /// 导入数据
        /// </summary>
        ...
        {
            const string templateFileName = "设备型号点检保养项目导入模板.xlsx";
        ...
        {
            return typeof(ImportEquipModelProjectHandle);
        }
    }
}
