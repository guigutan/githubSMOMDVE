...
namespace SIE.Web.EMS.Equipments.Models.Commands
{
    ...
    /// 添加保养项目
    /// </summary>
    [JsCommand("SIE.Web.EMS.Equipments.Models.Commands.SelModelMaintainCommand")]
    public class SelModelMaintainCommand : ViewCommand
    {
        /// <summary>
        /// 执行添加
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            foreach (var item in checkProjectInfos)
            {
                ...
                var checkProject = new EquipModelMaintainProject();
