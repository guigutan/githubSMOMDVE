...
namespace SIE.Web.EMS.AssetRequisitions.Commands
{
    ...
    /// 审核命令
    /// </summary>
    public class ApprovalAssetRequisitionCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<AssetRequisitionController>().ApprovalAssetRequisitions(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
