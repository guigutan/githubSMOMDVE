SIE.defineCommand('SIE.Web.EMS.AssetRequisitions.Commands.ApprovalAssetRequisitionCommand', {
    ...
    execute: function (view, source) {
        var win = SIE.Window.show({
            ...
            items: {
                ...
                items: [{
                    xtype: 'combobox',
                    id: 'AssetRequisitionsApproval_Result',
                    name: 'AssetRequisitionsApprovalResult',
                    margin: '5',
                    fieldLabel: '审核结果'.t(),
                    editable: false,
                    queryMode: 'local',
                    ...
                    xtype: 'textareafield',
                    grow: true,
                    id: 'AssetRequisitionsApproval_Opinions',
                    name: 'Opinions',
                    margin: '5',
                    fieldLabel: '审核意见'.t(),
                    anchor: '100%'
            ...
            id: "AssetRequisitionsApprovalCommand001",
            callback: function (btn) {
                if (btn == "确定".t()) {
                    var selectModels = view.getSelection();
                    var selectIds = view.getSelectionIds(selectModels);
                    var result = Ext.getCmp('AssetRequisitionsApproval_Result');
                    var opinions = Ext.getCmp('AssetRequisitionsApproval_Opinions');
                    var postdata = {
