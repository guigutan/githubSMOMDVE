Ext.define('SIE.Web.EMS.Checks.Confirmations.Editors.UploadFileEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.uploadPictureEditorForCheckPlanConfirmation',
    ...
    _createLayout: function (field) {
        ...
        var entity = Ext.create("SIE.Web.EMS.Checks.Confirmations.ViewModels.ImportFileViewModel");
        var detailView = null;
        SIE.AutoUI.getMeta({
            async: false,
            ...
            model: "SIE.Web.EMS.Checks.Confirmations.ViewModels.ImportFileViewModel",
