...
namespace SIE.Web.EMS.EarlierStage.Projects
{
    ...
    /// 项目查询视图-界面
    /// </summary>
    internal class ProjectCriteriaViewConfig : WebViewConfig<ProjectCriteria>
    {
        /// <summary>
        /// 配置查询视图
        /// </summary>
        protected override void ConfigQueryView()
        {
            ...
            View.Property(p => p.CreateDate).UseDateRangeEditor(p => p.DateRangeType = ObjectModel.DateRangeType.Year);
        }
    }
}
