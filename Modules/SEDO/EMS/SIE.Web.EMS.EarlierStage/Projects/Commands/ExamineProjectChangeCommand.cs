...
namespace SIE.Web.EMS.EarlierStage.Projects.Commands
{
    ...
    /// 审核项目变更
    /// </summary>
    [JsCommand("SIE.Web.EMS.EarlierStage.Projects.Commands.ExamineProjectChangeCommand")]
    public class ExamineProjectChangeCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            if (info == null)
            {
                throw new ValidationException("审核项目变更信息异常".L10N());
            }
            ...
            RT.Service.Resolve<ProjectChangeController>().ExamineProjectChange(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
