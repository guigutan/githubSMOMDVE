...
namespace SIE.Web.EMS.EarlierStage.Projects.Commands
{
    ...
    /// 审核项目结项
    /// </summary>
    [JsCommand("SIE.Web.EMS.EarlierStage.Projects.Commands.ExamineProjectCloseCommand")]
    public class ExamineProjectCloseCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            if (info == null)
            {
                throw new ValidationException("审核项目结项信息异常".L10N());
            }
            ...
            RT.Service.Resolve<ProjectChangeController>().ExamineProjectClose(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
