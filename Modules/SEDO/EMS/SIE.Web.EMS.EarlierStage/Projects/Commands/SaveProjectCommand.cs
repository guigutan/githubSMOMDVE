...
namespace SIE.Web.EMS.EarlierStage.Projects.Commands
{
    ...
    /// 保存项目
    /// </summary>
    [JsCommand("SIE.Web.EMS.EarlierStage.Projects.Commands.SaveProjectCommand")]
    public class SaveProjectCommand : FormSaveCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            if (entity != null)
            {
                ...
                RT.Service.Resolve<ProjectController>().SaveProject(project);
            }
            return entity;
        }
    }
