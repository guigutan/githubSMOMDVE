SIE.defineCommand('SIE.Web.EMS.EarlierStage.Budgets.Commands.ExamineBudgetCommand', {
    ...
    execute: function (view, source) {
        var win = SIE.Window.show({
            ...
            items: {
                ...
                items: [{
                    xtype: 'combobox',
                    id: 'ExamineBudget_Result',
                    name: 'ExamineBudgetResult',
                    margin: '5',
                    fieldLabel: '审核结果'.t(),
                    queryMode: 'local',
                    displayField: 'Name',
            ...
            id: "ExamineBudgetCommand001",
            callback: function (btn) {
                if (btn == "确定".t()) {
                    var selectModels = view.getSelection();
                    var selectIds = view.getSelectionIds(selectModels);
                    var result = Ext.getCmp('ExamineBudget_Result');
                    var opinions = Ext.getCmp('ExamineBudget_Opinions');
                    var postdata = {
