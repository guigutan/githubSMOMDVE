...
namespace SIE.Web.EMS.EarlierStage.Budgets.Commands
{
    ...
    /// 审核预算变更
    /// </summary>
    [JsCommand("SIE.Web.EMS.EarlierStage.Budgets.Commands.ExamineBudgetChangeCommand")]
    public class ExamineBudgetChangeCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            {
                throw new ValidationException("审核预算变更数据参数不能为空".L10N());
            }
            var info = args.Data.ToJsonObject<ExamineInfo>();
            if (info == null)
            {
                throw new ValidationException("审核预算变更信息异常".L10N());
            }
            ...
            RT.Service.Resolve<BudgetChangeController>().ExamineBudgetChange(selectedIds, info.ApprovalResult.Value, info.Remark);
            return true;
        }
    }
}
