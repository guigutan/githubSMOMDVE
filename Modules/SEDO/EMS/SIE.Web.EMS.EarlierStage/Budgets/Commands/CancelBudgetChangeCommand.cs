...
namespace SIE.Web.EMS.EarlierStage.Budgets.Commands
{
    ...
    /// 撤回预算变更
    /// </summary>
    [JsCommand("SIE.Web.EMS.EarlierStage.Budgets.Commands.CancelBudgetChangeCommand")]
    public class CancelBudgetChangeCommand : ViewCommand
    {
        /// <summary>
        /// 执行命令
        /// </summary>
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            RT.Service.Resolve<BudgetChangeController>().CancelBudgetChange(selectedIds);
            return true;
        }
    }
}
