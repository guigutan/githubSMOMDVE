Ext.define('SIE.Web.EMS.EquipRepair.EquipRepairs.Behaviors.EngineerConfirmDetailBehavior', {
    ...
    currentChanged: function (config) {
        ...
        if (this.getCurrent() && this.getCurrent() != null) {
            var picture = document.getElementById("engineerPicture");
            if (this.getCurrent().data.EngineerAttachment) {
                var filePath = this.getCurrent().getEngineerAttachment();
