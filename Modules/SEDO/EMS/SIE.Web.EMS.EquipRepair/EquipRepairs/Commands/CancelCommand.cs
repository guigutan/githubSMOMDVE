...
namespace SIE.Web.EMS.EquipRepair.EquipRepairs.Commands
{
    ...
    /// 维修取消
    /// </summary>
    [JsCommand("SIE.Web.EMS.EquipRepair.EquipRepairs.Commands.CancelCommand")]
    public class CancelCommand : ViewCommand
    {
        ...
        protected override object Excute(ViewArgs args, string scope)
        {
            ...
            var billSuspendViewModel = args.Data.ToJsonObject<BillCancelViewModel>();
            RT.Service.Resolve<RepairController>().BillCancel(billSuspendViewModel);
