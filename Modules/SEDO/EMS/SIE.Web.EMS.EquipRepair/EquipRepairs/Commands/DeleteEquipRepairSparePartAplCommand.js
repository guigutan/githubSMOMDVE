SIE.defineCommand('SIE.Web.EMS.EquipRepair.EquipRepairs.Commands.DeleteEquipRepairSparePartAplCommand', {
    ...
    canExecute: function (listview) {
        if (listview.getParent().getCurrent()) {
            ...
            if (this.selectedItems.length === 0)
                return false;
            if (this.selectedItems.any(function (p) { return p.data.IsApply == true; }))
                return false;
