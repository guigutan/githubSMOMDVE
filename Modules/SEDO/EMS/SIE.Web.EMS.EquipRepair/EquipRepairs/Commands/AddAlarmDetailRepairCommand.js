//报警明细维修
SIE.defineCommand('SIE.Web.EMS.EquipRepair.EquipRepairs.Commands.AddAlarmDetailRepairCommand', {
    extend: 'SIE.cmd.Add',
    ...
    addPage: function (opt) {
        var tabId = 'tab_CreateEquipRepairBill_003';

        //防止确认异常和查看异常按钮打开同一个页签
        opt.tabId = tabId;

        var additionParams = {
            equipmentAccountID: this.view.getCurrent().getEquipAccountId(),
            sourceNo: this.view.getCurrent().getCode(),
            //来源类型 报警明细=7
            sourceType: 7
        };
