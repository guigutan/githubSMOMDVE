Ext.define('SIE.Web.EMS.EquipRepair.EquipRepairs.Scripts.UploadEngineerFileEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.uploadfileeditor_engineerConfirm',
                            ...
                            SIE.invokeDataQuery({
                                ...
                                callback: function (result) {
                                    if (result.Success) {
                                        ...
                                        if (result.Result != "") {
                                            detailView.mainView.getCurrent().setProjectNameView(result.Result);
                                            detailView.mainView.getCurrent().data.EngineerAttachment = result.Result;
                                            return false;
                                        }
                                        else {
