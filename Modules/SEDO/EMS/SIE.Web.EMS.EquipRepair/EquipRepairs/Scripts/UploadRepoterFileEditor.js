Ext.define('SIE.Web.EMS.EquipRepair.EquipRepairs.Scripts.UploadRepoterFileEditor', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.uploadfileeditor_repoter',
                        ...
                        callback: function (btn) {
                            ...
                            if (btn == "确定".t()) {
                                ...
                                SIE.invokeDataQuery({
                                    ...
                                    method: "UploadOutsourcedMaintenanceReport",
                                    params: [current.getId(),detailView.FileContent, detailView.FileName],
                                    async: false,
                                    ...
                                    callback: function (result) {
                                        if (result.Success) {
                                            ...
                                            if (result.Result != "") {
                                                detailView.mainView.getCurrent().setOutsourcedMaintenanceReport(result.Result);
                                                return false;
                                            }
                                        }
                                    },
