SIE.defineCommand('SIE.Web.EMS.SpecialEquipment.RegularInspections.Commands.SaveRegularInspectionCommand', {
   ...
   */
    canExecute: function (view) {
        ...
        return data.SpecialEquipmentAccountId > 0 && data.InspectionRuleId > 0;
    },

    execute: function (view) {
        var me = this;
        me.saveRegularInspection(view);
       
    },

    saveRegularInspection: function (view) {
        var me = this;
        var data = view.getCurrent().data;
        var children = view.getChildren();
        if (!this.onValidation(view)) { SIE.MessageBox.showError("信息填写不完整！".L10N()); return; }

        var detailChild = children.first(function (p) { return p.model == "SIE.EMS.SpecialEquipment.RegularInspections.RegularInspectionDetail"; });
        var details = [];
        ...
        data.RegularInspectionDetailList = details;
    ...
    onSaved: function (view, res) {
        ...
        window.setTimeout(function () {
            CRT.Event.fire("SIE.EMS.SpecialEquipment.RegularInspections.RegularInspection_refresh");
