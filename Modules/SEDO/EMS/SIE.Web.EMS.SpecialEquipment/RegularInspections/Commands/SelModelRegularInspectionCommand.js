SIE.defineCommand('SIE.Web.EMS.SpecialEquipment.RegularInspections.Commands.SelModelRegularInspectionCommand', {
    ...
    execute: function (listView, source) {
        ...
        if (!this.viewMeta) {
            SIE.AutoUI.getMeta({
                ...
                model: "SIE.EMS.SpecialEquipment.RegularInspections.ViewModels.SelInspectionProjectViewModel",
                callback: function (res) {
                    ...
                    if (dialogView.getRelations() && dialogView.getRelations().length > 0 && dialogView.getRelations()[0].getTarget() && view.getView().getRelations()[0].getTarget().viewGroup === 'QueryView') {
                        ...
                        queryView.getData().data.SpecialEquipmentAccountId = wodata.SpecialEquipmentAccountId;
                            ...
                            callback: function (btn) {
                                if (btn == "确定".t()) {
                                    ...
                                    for (var resdata of datas) {
                                        ...
                                        newData.data.ProjectName = resdata.data.Name;
