...
{
    internal class SpecialEquipmentAccountCriteriaViewConfig : WebViewConfig<SpecialEquipmentAccountCriteria>
    {
        /// <summary>
        /// 默认查询视图
        /// </summary>
        protected override void ConfigView()
        {
            ...
            using (View.OrderProperties())
            {
                ...
                {
                    var criteria = e as SpecialEquipmentAccountCriteria;
                    if (criteria == null) { 
                ...
                View.Property(p => p.Resource)
                    .UseDataSource((e, c, r) =>
                    {
                        var equipAccountCriteria = e as SpecialEquipmentAccountCriteria;
