SIE.defineCommand('SIE.Web.EMS.SpecialEquipment.Commands.SelEquipAccountInspectionCommand', {
        ...
        if (selections && selections.items.length > 0) {
            ...
            SIE.each(selections.items, function (item) {
                ...
                if (me._sourceViewSelectItems.indexOf(itemId) === -1) {
                    var equipModelRegularInspection = { SpecialEquipmentAccountId: me._sourceId, InspectionRuleId: itemId };
        ...
        if (me._targetView !== null) {
            ...
            if (store !== null) {
                ...
                if (dialogView._relations[0]) { //存在查询面板时
                    ...
                    criteria.InspectionRuleType = 10;
