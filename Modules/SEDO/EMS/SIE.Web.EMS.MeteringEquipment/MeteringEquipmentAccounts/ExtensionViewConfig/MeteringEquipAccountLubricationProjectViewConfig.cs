...
{ 
    ...
    /// 设备型号润滑项目视图配置
    /// </summary>
    internal class MeteringEquipAccountLubricationProjectViewConfig : WebViewConfig<MeteringEquipAccountLubricationProject>
    {
        /// <summary>
        /// 字符显示宽度
        /// </summary>
        ...
        protected override void ConfigListView()
        {
            ...
            View.UseCommands("SIE.Web.EMS.Equipments.Accounts.Commands.EquipAccountLubricationProjectAddCommand", 
                ...
                typeof(MeterEquipAccountLubricationProjectSaveCommand).FullName);
