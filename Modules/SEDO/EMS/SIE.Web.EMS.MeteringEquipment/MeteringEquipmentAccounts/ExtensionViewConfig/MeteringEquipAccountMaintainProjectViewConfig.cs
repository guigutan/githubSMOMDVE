...
namespace SIE.Web.EMS.MeteringEquipment.MeteringEquipmentAccounts.ExtensionViewConfig
{
    ...
    /// 设备台账保养项目视图配置
    /// </summary>
    public class MeteringEquipAccountMaintainProjectViewConfig : WebViewConfig<MeteringEquipAccountMaintainProject>
    {
        /// <summary>
        /// 保养计划添加保养项目视图
        /// </summary>
        ...
        protected override void ConfigListView()
        {
            ...
            using (View.OrderProperties())
            {
                ...
                {
                    m.DisplayField = MeteringEquipAccountMaintainProject.DepartmentNameViewProperty.Name;
                    m.BindDisplayField = MeteringEquipAccountMaintainProject.DepartmentNameViewProperty.Name;
