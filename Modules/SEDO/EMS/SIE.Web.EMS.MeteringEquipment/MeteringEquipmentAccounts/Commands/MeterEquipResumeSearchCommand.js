SIE.defineCommand('SIE.Web.EMS.MeteringEquipment.MeteringEquipmentAccounts.Commands.MeterEquipResumeSearchCommand', {
    ...
    execute: function (view) {
        if (view.getParent()) {
            ...
            if (parent && cbResumeState) {
                parent.setMeteringResumeStateDontMap(cbResumeState.getValue());
            }
