SIE.defineCommand('SIE.Web.EMS.MeteringEquipment.MeteringEquipmentAccounts.Commands.SynMeteringModelCommand', {
    extend: 'SIE.cmd.Edit',
    meta: { text: "同步型号数据", group: "edit", iconCls: "icon-EditEntity icon-blue" },
