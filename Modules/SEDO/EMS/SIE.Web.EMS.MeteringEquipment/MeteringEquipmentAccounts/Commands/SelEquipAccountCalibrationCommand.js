SIE.defineCommand('SIE.Web.EMS.MeteringEquipment.MeteringEquipmentAccounts.Commands.SelEquipAccountCalibrationCommand', {
        ...
        if (selections && selections.items.length > 0) {
            ...
            SIE.each(selections.items, function (item) {
                ...
                if (me._sourceViewSelectItems.indexOf(itemId) === -1) {
                    var equipAccountCalibration = { MeteringEquipmentAccountId: me._sourceId, InspectionRuleId: itemId };
                    operationDatas.push(equipAccountCalibration);
                }
            });
