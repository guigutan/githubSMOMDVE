SIE.defineCommand('SIE.Web.EMS.MeteringEquipment.Calibrations.Commands.SeeReportCommand', {
    extend: 'SIE.cmd.Edit',
    ...
    showView: function (editEntity) {
        var me = this;
        var entityId = editEntity.entityName + '-' + "SeeReportView" + '-' + editEntity.getId();
