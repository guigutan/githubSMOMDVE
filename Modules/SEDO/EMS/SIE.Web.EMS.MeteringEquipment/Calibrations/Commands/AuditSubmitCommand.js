SIE.defineCommand('SIE.Web.EMS.MeteringEquipment.Calibrations.Commands.AuditSubmitCommand', {
    extend: 'SIE.cmd.FormSave',
    meta: { text: "通过", group: "edit", iconCls: "icon-PlaylistCheck icon-blue" },
    ...
    execute: function (view, source) {
        ...
        if (!this.onSaving(view))
            return false;
        SIE.Msg.askQuestion("是否审核通过？审核通过后单据不能修改。".t(),
            function () {
