Ext.define('SIE.Web.EMS.EquipMaint.Maintains.Confirmations.Scripts.ConfirmMaintainPlanBehavior',
    {
        /**
         * view生命周期函数--view生成前
         * @param {*} meta 实体视图元数据
        ...
        */
        onCreated: function (view) {
            ...
            if (params) {
                ...
                entity.setExeState(params.MaintianExeState);
        ...
        */
        ...
        hideTab: function (view) {
            view.findChild("SIE.EMS.Maintains.Confirmations.MaintainConfirmation").getControl().ownerLayout.owner.tab.hide()
            view.findChild("SIE.EMS.Maintains.Projects.MaintainProject").getControl().up("tabpanel").setActiveTab(1)
        },
        /**
         * view生命周期函数--数据加载后
         * @param {any} view 逻辑视图
