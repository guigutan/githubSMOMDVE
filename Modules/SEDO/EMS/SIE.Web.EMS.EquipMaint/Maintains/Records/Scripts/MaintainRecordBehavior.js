Ext.define('SIE.Web.EMS.EquipMaint.Maintains.Records.Scripts.MaintainRecordBehavior', {
    ...
    beforeCreate: function (meta, curEntity) {
        var me = this;
        if (!meta) return;
        if (meta.model != 'SIE.EMS.Maintains.Records.MaintainRecord') return;
        ...
        var render = {
            renderer: function (value, meta, record, rowIndex, colIndex, store, view) {
                ...
                return record.data.ExeStateName;
            }
    ...
    compatibleWithIE: function () {
        ...
        if (params) {
            ...
            //赋值传递过来的保养单号
            criteria.setMaintainNo(params.MaintainNo);
            //清空所有时间范围控件的开始结束时间
