SIE.defineCommand('SIE.Web.EMS.EquipMaint.Maintains.Records.Commands.ShowMaintainPicture', {
    extend: 'SIE.cmd.Edit',
    ...
    showView: function (editEntity) {
        ...
        me.getPhoto(mainView.token, editEntity.getId(), function (photo) {
            ...
            SIE.AutoUI.getMeta({
                ...
                model: "SIE.Web.EMS.EquipMaint.Maintains.Records.ViewModels.MaintainRecordProjectViewModel",
    ...
    getPhoto: function (token, projectId, callback) {
        SIE.invokeDataQuery({
            method: 'GetMaintainProjectPhoto',
            params: [projectId],
            action: 'queryer',
            type: 'SIE.Web.EMS.Maintains.Records.DataQuery.MaintainRecordDataQueryer',
            token: token,
