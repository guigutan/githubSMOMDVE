SIE.defineCommand('SIE.Web.EMS.EquipMaint.Maintains.Plans.Commands.SelSparePartAplCommand', {
        ...
        if (selections && selections.length > 0) {
            ...
            SIE.each(selections, function (item) {
                ...
                if (me._sourceViewSelectItems.indexOf(sparePartId) === -1) {
                    var maintainPlanSparePart = { MaintainPlanId: me._sourceId, SparePartId: sparePartId };
                    operationDatas.push(maintainPlanSparePart);
                }
            });
